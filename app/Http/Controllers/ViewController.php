...
class ViewController extends Controller
{
  ...
  public function home()
  {
    ...
    $consulta = TipoCambio::where('fecha', Carbon::now()->format('Y-m-d'))->first();
    if (!$consulta) {
      return view('home', compact('empresa', 'moneda_principal', 'return_tot_fact', 'return_tot_bol', 'return_kardex', 'return_kardex_ext', 'array_prod_all'))->with('error', 'Tipo de cambio no registrado')->with('check_tipo_cambio', true);
    } else {
      return view('home', compact('empresa', 'moneda_principal', 'return_tot_fact', 'return_tot_bol', 'return_kardex', 'return_kardex_ext', 'array_prod_all'));
    }
  }
}
