        ...
        return [
            ...
            'manyProjects' => [
                ...
                'Responsable' => function ($item) {
                    return $item->responsable->nombre ?? $item->responsable->personal->nombres . ' ' . $item->responsable->personal->apellidos;
                },
                'Cliente' => function ($item) {
                    return $item->cliente ? $item->cliente->nombre : "Sin cliente"; // clientes sin nombre
                },
                'Administrador' => function ($item) {
                    return $item->responsable->nombre ??$item->administrador->personal->nombres . ' ' . $item->administrador->personal->apellidos;
                },
                'Servicio' => function ($item) {
                    return optional($item->servicio)->nombre ?? 'N/A';
                },
