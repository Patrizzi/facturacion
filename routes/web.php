...
// ServicioController:
    ...
    Route::get('/servicio/guia_salida', 'ServicioController@mostrarGuiaSalida')->name('servicio.guia_salida');
    ...
    Route::get('/servicio/guia_salida/{id}', 'GuiaServicioController@mostrarGuiaSalida')->name('servicio.guiaSalida');
