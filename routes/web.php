...
Route::get('/servicio/guia_de_salida', 'GuiaSalidaController@guia_de_salida')->name('servicio.guiasalida');
    ...
    // Excel productos
    Route::get('/productos/importar', [ProductosController::class, 'importarVista'])->name('productos.importar.vista');
    Route::post('/productos/importar', [ProductosController::class, 'importarProductos'])->name('productos.importar');
