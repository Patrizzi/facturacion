...
@section('content')
    ...
    <div id="seccion1" class="contenido activo">
        ...
        <!-- CSS DE VIÑETA -->
        <style>
            /* Estilos para el acordeón de ingreso */
            .accordion {
                margin-top: 50px;
            }
            .accordion-button {
        ...
        <div>
            ...
            <div class="wrappercontenedor">
                ...
                <div class="containercontenedor2" style="align-self: flex-end;">
                    ...
                    <div class="input-groupcontenedor">
                        <label for="recepcionista" class="input-labelcontenedor">Recepcionista:</label>
                        <input type="text" id="recepcionista" name="recepcionista" class="input-fieldcontenedor" value="{{ optional(optional($datos_generales)->personal_laborales)->nombres ?? '-' }} {{ optional(optional($datos_generales)->personal_laborales)->apellidos ?? '-' }}" readonly>
                        <label for="fecha_ingreso" class="input-labelcontenedor">Fecha Ingreso:</label>
                        <input type="date" id="fecha_ingreso" name="fecha_ingreso" class="input-fieldcontenedor" value="{{ optional($datos_generales)->created_at?->format('Y-m-d') ?? '-' }}" readonly>
                    </div>
                    {{-- <div class="input-groupcontenedor">
