...
@section('content')
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" id="tab-5" class="tab-pane active show">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="dateranger_boleta"
                                                    value="{{ date('m/01/Y') }} - {{ date('m/t/Y') }}" />
                                                <span class="input-group-append">
                                                    <button type="button" class="btn btn-secondary"
                                                        onclick="revert_select_boleta()">
                                                        <i class="fa fa-history"></i>
                                                    </button>
                                                </span>
                                                <span class="input-group-append">
                                                    <button type="button" class="btn btn-primary"
                                                        onclick="limpiar_select_boleta()">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-striped dataTables-boleta">
                                        <thead>
                                            <tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            table = $('.dataTables-boleta').DataTable({
                pageLength: 12,
                responsive: true,
            ...
            $('input[name="dateranger_boleta"]').daterangepicker({
        ...
        function limpiar_select_boleta() {
            table.column(5).search("").draw();
        }

        function revert_select_boleta() {
