...
@section('content')
                        ...
                        <div class="tab-content" style="margin-top: -2px">
                            <div role="tabpanel" id="tab-6" class="tab-pane active show" style="margin-top: -1px;border-top: 1px solid #e7eaec !important;">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered table-striped dataTables-remision">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            @foreach ($guia_remisiones as $index => $guia_remision)
                                                <tr @if ($guia_remision->diff_day > 10) style="color: red" @endif>
                                                    <td><input type="checkbox" class="i-checks-remision"
                                                            name="input_re,mision[]"
    ...
    <script>
        ...
        $('tbody input.i-checks-remision').on('ifChanged', function(event) {
            ...
            var checkboxesHabilitados = table.find('tbody input.i-checks-remision').not(':disabled');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (result == "Codigo Error:") {
                        var data = `
                            <div id="alert_one_remision" class="alert alert-danger">
