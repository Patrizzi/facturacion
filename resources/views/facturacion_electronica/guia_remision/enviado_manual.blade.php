...
@section('content')
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="dateranger_remision"
                                                    id="dateranger_remision" readonly
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tab_remision_m_env').addClass('active');
            // CHEK
            ...
            var table_remision_env = $('.dataTables-example5').DataTable({
                "serverSide": true,
                "ajax": {
                    url: "{{ route('guias_electronicas.list_remision_m_env') }}",
                    method: "get",
                    data: function(d) {
        ...
        $(document).on('click', '.boton-anular', function() {
            ...
            swal({
                    title: "¿Estás seguro?",
                    text: "Vas a anular la Guia M: " + codigo +
                        " y se efectuará el re-stock de los Productos. Esto no anulará la Guia en Sunat, eso debe realizarse desde el mismo portal SOL",
                    type: "warning",
