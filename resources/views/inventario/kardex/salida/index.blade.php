                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row" align="center">
                                ...
                                <div class="col-sm-12">
                                    @if ($conteo_almacen == 1)
                                        <form action="{{ route('kardex-salida.create') }}" enctype="multipart/form-data"
                                            method="post">
                                            @csrf
                                    ...
                                    @else
                                        @if ($user_login->name == 'Administrador')
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <form action="{{ route('kardex-salida.create') }}"
                                        ...
                                        @elseif($user_login->name == 'Colaborador')
                                            <form action="{{ route('kardex-salida.create') }}" enctype="multipart/form-data"
                                                method="post">
                                                @csrf
                                                <input type="text" hidden="hidden" name="almacen"
                                                    value="{{ $user_login->almacen_id }}">
                                                <input type="submit" class="btn btn-sm btn-info"
                                                    value="Crear una cotizacion factura">
                                            </form>
                                        @endif
                                    @endif
                                </div>
                                            ...
                                            <tbody>
                                                @foreach ($kardex_salidas as $kardex_salida)
                                                    <tr class="gradeX">
                                                        ...
                                                        <td>
                                                            @can('kardex_salida.ver')
                                                                <center>
                                                                    <a href="{{ route('kardex-salida.show', $kardex_salida->id) }}"><button
                                                                            type="button"
