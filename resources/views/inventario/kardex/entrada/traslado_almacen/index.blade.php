...
@section('content')
    ...
    {{-- modal redireccion --}}
    <div class="modal fade" id="Modal_Select_Almacen" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <div>
                    <div class="ibox-content" style="padding-left: 0px;padding-right: 0px;" align="center"
                        ...
                        <form action="{{ route('kardex-entrada-Traslado-almacen.create') }}" enctype="multipart/form-data"
                            method="post">
                            @csrf
                            <div class="form-group  row">
                                <div class="col-sm-12" style="padding-bottom: 15px"><img
                                        src="{{ asset('/archivos/imagenes/kardex_img/2795451.svg') }}" width="150px"></div>
    ...
    <div id="CreateTraslado" class="modal fade" style="display: none;" aria-modal="true" data-backdrop="static"
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>@can('kardex_traslado.ver') Ver @endcan</th>
                                                    {{-- <th>Anular</th> --}}
                                                    <th>Estado</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                @foreach ($kardex_distribucion as $kardex_distribuciones)
                                                    <tr class="gradeX">
                                                        ...
                                                        <td>
                                                            @if($kardex_distribuciones->estado == 1)
                                                                <button class="btn btn-success btn-circle btn-ls"
                                                                    title="Activo">
