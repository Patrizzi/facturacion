...
<table style="width: 100%;border-collapse:separate;vertical-align: inherit">
    <tr>
        <td style="border: 1px #e5e6e7 solid;border-radius: 10px;width: auto;padding-top: 5px;text-align: center;vertical-align: inherit;"
            align="center">
            <img align="center" src="{{ asset('img/logos/' . $empresa->foto) }}"
                style="height: 50px;width: 150px;margin-top: 5px;">
        </td>
        {{-- <td style="width: 5px;border: 1px white"></td> --}}
        <td style="width: 33%;border: 1px white"></td>
        {{-- <td style="width: 5px;border: 1px white"></td> --}}
        <td style="border: 1px #e5e6e7 solid;border-radius: 10px;width: auto;margin-top: -10px;text-align: center;"
            align="center">
    ...
    <table class="table table-striped table-bordered table-hover dataTables-example" style="text-align: center;">
        ...
        <tbody>
            @foreach ($productos as $producto)
                <tr>
                    <td style="display: none">{{ $pre_nac += $producto['precio_nacional'] }}
                        {{ $pre_ex += $producto['precio_extranjero'] }}
                        {{ $cant_ini += $producto['cantidad_inicial'] }}</td>
