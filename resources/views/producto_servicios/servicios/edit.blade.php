 ...
 <div class="panel panel-default">
  <div class="panel-body" align="left">
   <div class="row">
    ...
    <div class="col-sm-10"><input type="text" class="form-control" onkeypress="return (event.charCode != 34 )" name="nombre" placeholder="Nombre del Producto" required="required" value="{{$servicios->nombre}}" ></div>
