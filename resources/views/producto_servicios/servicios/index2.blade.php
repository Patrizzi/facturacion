                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" id="tab-2" class="tab-pane active show">
                                    <div class="panel-body table-responsive">
                                        ...
                                        <br>
                                        <table class="table table-striped dataTables-servicios2">
            ...
            $('.dataTables-servicios2').DataTable({
                ...
                "columnDefs": [{
                    ...
                    'render': function(data, type, full, meta) {
                        ...
                        return "<center><a href='{{ route('servicios.show', '') }}/" + full[
                            0] +
                            "'><button type='button' class='btn btn-success btn-sm'><i class='fa fa-eye'></i></button></a></center>";
                    }
                }]
            });
