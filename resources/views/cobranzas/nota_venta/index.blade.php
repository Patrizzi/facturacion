...
@section('title', 'Pagos de Nota de Ventas')
@section('content')
    ...
    {{-- @include('cobranzas.nota_venta._shared.statitics') --}}
                            ...
                            <div class="tab-content" style="margin-top: -1px">
                                <div class="tab-pane active show" role="tabpanel" id="tab-1"
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            class="table table-striped table-bordered table-hover dataTables-example-notaVenta">
                                            <thead>
                                                <tr>
                                                    <th>Item</th>
                                                    <th>Estado</th>
    ...
    <script>
        ...
        // FUNCION DE DATATABLE NOTA DE VENTA 
        var fact_table = $('.dataTables-example-notaVenta').DataTable({
            "serverSide": true,
            "ajax": {
                url: "{{ route('cobranzas.lista_nota_venta_index') }}",
                method: "get",
                data: function(d) {
                    ...
                    'render': function(data, type, full, meta) {
                        ...
                        href=" ` + url_view + `"><i class="fa fa-eye"></i></a>
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#" onclick="pago_factura(` + full[8] + `)">Pagar</a></li>
    ...
    <script>
        ...
        function pago_factura(n_factura) {
            ...
            var only_id_fact = `
                <input type="hidden" name="id_nventa[]" class="" id="id_factura_` + n_factura + `" value="` +
                n_factura + `">
            `;
        ...
        function check_lote(num) {
            ...
            if (elemento[0].checked) {
                ...
                var only_id_fact = `
                    <input type="hidden" class="option_select_comprobantes" name="id_nventa[]" id="id_factura_` +
                ...
                success: function(msg) {
                    ...
                    msg.forEach(function(row, index) {
                        ...
                        var data = `
                            ...
                            `</strong></span>
                                            <input class="form-control" type="hidden" name="numero_nventa[]" id="numero_fac_` +
