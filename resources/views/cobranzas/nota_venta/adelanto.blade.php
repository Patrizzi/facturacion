<div class="modal inmodal fade" id="myModal5" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('adelantos.store_nota_venta')}}" method="post" >  {{-- NOTA VENTA --}}
                @csrf
                ...
                <div class="modal-body">
                    <div class="metodo_adelanto">
                        ...
                        <div id="id_nota_venta_adl">
                        </div>
                        <div class="row">
                            <div class="col-sm-3">
                                <h3 class="text-center">Adelanto para Nota Venta.</h3>
...
<script>
    ...
    function pago_adelanto(n_venta, tipo, cuota_id){  // PARA FACTURA NORMAL
        // tipo === ONLY : VIEW EDIT || FULL || INDEX
        console.log(tipo);
        $('#adelanto_header').empty();
        var serie = $(`#serie_comp_`+cuota_id).val();
        var n_cuota = 1;
        var n_cuota_view = 1;
        var simbolo_precio = $(`#simbolo_precio_`+cuota_id).val();
        ...
        var data_html = `
            <div class="col-sm-4">
                <h3 class="text-center">N° de Nota Venta</h3>
