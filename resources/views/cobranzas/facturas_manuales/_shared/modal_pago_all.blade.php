                             ...
                             <div id="collapseThree" class="panel-collapse collapse">
                                 <div class="panel-body">
                                    ...
                                    <div class="col-sm-12">
                                     ...
                                     {{-- Columna de Facturas y Cuotas --}}
                                     <div class="row">
                                         <label></label>

                                         <!-- Número de Factura -->
                                         {{-- <div class="col-sm-4">
                                         <label class="form-control">F001-00000001</label>
                                         <input class="form-control" type="hidden" name="numero_factura_m[]"
                                             id="numero_fac_0" value="F001-00000001">
                                     </div> --}}

                                         <!-- Select de Cuotas -->
                                         <div class="col-sm-12">
                                             <div class="d-flex align-items-center my-2">
                                                 {{-- <div class="border-top me-3" style="flex:0 0 5%;"></div> --}}
                                                 <span class=" fw-bold"><strong>F001-00000001</strong></span>
                                                 {{-- <div class="border-top ms-3 flex-grow-1"></div> --}}
                                             </div>
                                         </div>
                                         <div class="col-sm-8 div_select">
                                             <select data-placeholder="Seleccionar 1 o más cuotas" class="chosen-select"
                                                 multiple style="width: 100% !important;" tabindex="4">
                                                 <option value="100.00">Cuota 1 - 100.00</option>
                                                 <option value="150.00">Cuota 2 - 150.00</option>
                                             </select>
                                             {{-- <select placeholder="Seleccionar Cuotas" id="sel_0"
                                             class="select_2_multipl_0 select2-selection--multiple"
                                             name="cuotas_precio_F001-00000001[]" multiple="multiple"
                                             onchange="select_2_(0)" required>
                                                <option value="100.00">Cuota 1 - 100.00</option>
                                                <option value="150.00">Cuota 2 - 150.00</option>
                                         </select> --}}
                                         </div>
                                     ...
                                     <hr>
                                     {{-- Total dela suma de todas las facturas --}}
                                     <div class="row">
                                         <div class="col-sm-7">
                                         ...
                                         <div class="col-sm-5">
                                             <div class="input-group  input-group-sm">
                                                 ...
                                                 <label class="form-control form-control" id="lbl_gran_tot"
                             ...
                             <div id="collapseFour" class="panel-collapse collapse">
                                 <div class="panel-body">
                                     ...
                                     <div class="row text-center" style="justify-content: space-around;">
                                         <div class="col-sm-3">
                                             <button class="btn btn-primary btn-block">Cheque</button>
                                         </div>
                                         <div class="col-sm-3">
                                             <button class="btn btn-primary btn-block">Tarjeta</button>
                                         </div>
                                         <div class="col-sm-3">
                                             <button class="btn btn-primary btn-block">Efectivo / QR</button>
                                         </div>
                                         <div class="col-sm-3">
                                             <button class="btn btn-primary btn-block">Transferencia</button>
                                         </div>
                                     </div>
                                 </div>
                             </div>
