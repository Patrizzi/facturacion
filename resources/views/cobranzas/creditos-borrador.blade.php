                ...
                <div class="ibox-content">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs" role="tablist">
                            <!-- Pestaña 1: Pagados -->
                            <li><a class="nav-link active show" data-toggle="tab" href="#tab-1G">Pagados</a></li>
                            <!-- Pestaña 2: Sin Pagar -->
                            <li><a class="nav-link" data-toggle="tab" href="#tab-2G">Sin Pagar</a></li>
                        </ul>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><div class="icheckbox_square-green checked" style="position: relative;"></div></td>
                                                    <td>1</td>
                                                    <td>B001-00000001</td>
                                                    <td>Marco Estrada</td>
                                                    <td>07-10-2024</td>
                                            ...
                                            <div class="ibox">
                                                <div class="ibox-content">
                                                    <div class="tabs-container">
                                                        ...
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link " data-toggle="tab" href="#tab-1-Sin">
                                                                    <span class="badge badge-success" style="background-color: green;">4</span> Boleta 
                                                                </a>
                                                            </li>
                                                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                         <!-- COTIZACION-->   
                            <div role="tabpanel" id="tab-1-Sin" class="tab-pane">
                                <div class="panel-body">
                                    <!--Row-->
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
