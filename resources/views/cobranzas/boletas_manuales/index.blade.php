...
@section('content')
    ...
    {{-- @include('cobranzas.boletas_manuales._shared.statitics') --}}
    ...
    <script>
        ...
        var fact_m_table = $('.dataTables-example-facturas_manual').DataTable({
            "serverSide": true,
            "ajax": {
                url: "{{ route('cobranzas.lista_boletas_manual_index') }}",
                method: "get",
                data: function(d) {
    ...
    <script>
        ...
        // PAGO INDIVIDUAL
        function pago_boleta(n_factura) {
            // console.log('a');
            $('#div_facturas').empty();
        ...
        $(document).ready(function() {
            ...
            $('#btn-exportar-filtrado').on('click', function(e) {
                ...
                swal({
                    ...
                    $.ajax({
                        url: "{{ route('cobranzas.boletasM_exportar_sin_pago') }}",
                        method: "POST",
                        ...
                        success: function(blob) {
                            ...
                            a.href = url;
                            a.download = `Boletas_M_${new Date().toISOString().slice(0,10)}.xlsx`;
