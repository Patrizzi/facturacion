...
@section('content')
    ...
    {{-- @include('cobranzas.boletas._shared.statitics') --}}
                            ...
                            <div class="tab-content" style="margin-top: -1px">
                                <div class="tab-pane active show" role="tabpanel" id="tab-1"
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            class="table table-striped table-bordered table-hover dataTables-example-boletas">
                                            <thead>
                                                <tr>
    ...
    <script>
        ...
        $('#comprobante_titulo').text('Boletas');
        ...
        var boletas_table = $('.dataTables-example-boletas').DataTable({
            "serverSide": true,
            "ajax": {
                url: "{{ route('cobranzas.lista_boletas_index') }}",
                method: "get",
                data: function(d) {
    ...
    <script>
        $(document).ready(function() {
            ...
            $('thead input[type="checkbox"]').on('ifChecked ifUnchecked', function(event) {
                ...
                if (event.type === 'ifChecked') {
                    ...
                    getAllIds(function(ids) {
                        ...
                        isUpdatingCheckboxes = true;
                        $('.dataTables-example-boletas tbody input[type="checkbox"]').iCheck('check');
                        isUpdatingCheckboxes = false;
                    });
                } else {
                    masterChecked = false;
                    ...
                    isUpdatingCheckboxes = true;
                    $('.dataTables-example-boletas tbody input[type="checkbox"]').iCheck('uncheck');
                    isUpdatingCheckboxes = false;
                }
            });

            // Checkboxes individuales
            $(document).on('ifChecked ifUnchecked', '.dataTables-example-boletas tbody input[type="checkbox"]', function(event) {
                ...
                var rowData = boletas_table.row(row).data();
            ...
            boletas_table.on('draw', function() {
                // closeWhatsappPanels();
                // closeEmailPanels();
                ...
                $('.dataTables-example-boletas tbody input[type="checkbox"]').iCheck({
                    checkboxClass: 'icheckbox_square-green',
                    radioClass: 'iradio_square-green',
                });
                ...
                setTimeout(function() {
                    ...
                    $('.dataTables-example-boletas tbody input[type="checkbox"]').each(function() {
                        var row = $(this).closest('tr');
                        var rowData = boletas_table.row(row).data();
            ...
            $('#btn-exportar-filtrado').on('click', function(e) {
                ...
                swal({
                    ...
                    $.ajax({
                        url: "{{ route('cobranzas.boletas_exportar_sin_pago') }}",
                        method: "POST",
