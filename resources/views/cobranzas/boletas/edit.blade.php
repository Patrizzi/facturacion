...
@section('content')
    ...
    <input type="hidden" name="" id="serie_comp" value="{{$cod_bol}}">
    <input type="hidden" name="" id="simbolo_precio" value="{{$boleta->moneda->simbolo}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <p class="form-control">{{ $boleta->moneda->simbolo }}
                                                            <span hidden>{{ $sum_total = $bol_cuotas->sum('monto')}}</span>
                                                    ...
                                                    <div class="col-sm-7">
                                                        <p class="form-control">{{ $boleta->moneda->simbolo }}
                                                            <span
                                                                ...
                                                                {{ $tot = round($subtotal + ($boleta->op_gravada * $igv->renta) / 100, 2)}}
                                                            </span>
                                                            {{ number_format($tot, 2) }}
                                                        </p>
                                                    </div>
                                                    ...
                                                    <table
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Fecha Inicio</th>
                                                                <th>Fecha Ven.</th>
                                                                <th data-hide="all" style="display: none !important;">Días de Restraso:
                                                                </th>
                                                ...
                                                @else
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 text-right">
                                                            @if ($boleta->estado_pago != 2)
                                                                <button class="btn btn-primary" id="pago" onclick="modal_pagos({{$boleta->id}},'contado')">Pagar</button>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div role="tabpanel" id="tab-2" class="tab-pane">
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 text-right" >
                                                        @if ($boleta->estado_pago != 2)
                                                            <button class="btn btn-primary" id="adelantos_0"  data-toggle="modal" data-target="#myModal5" onclick="pago_adelanto({{$boleta->id}},'only','0')">Adelantar</button>
                                                        @endif
                                                    </div>
                                                </div>
                                                            ...
                                                            @if (is_object($adelantos_reg))
                                                                @foreach ($adelantos_reg as $index =>  $adl_reg)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$boleta->moneda->simbolo}} {{number_format($adl_reg->montos_input,2)}}</td>
    ...
    @include('cobranzas.pago_contado_boleta')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#id_boleta').attr('name', 'id_boleta[]');
            $('#cod_boleta').attr('name', 'numero_boleta[]');
        });
