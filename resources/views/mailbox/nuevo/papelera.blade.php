                                ...
                                <div role="tabpanel" id="tab-4" class="tab-pane active show">
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover text-center datatables-papelera">
                                                <thead>
                                                    <tr>
