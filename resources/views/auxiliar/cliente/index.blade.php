                                        ...
                                        <div class="panel-body">
                                            ...
                                            <table class="table table-striped table-hover text-md-center" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><input class="check_all_remi" type="checkbox" ></td>
                                                        <td>{{$cliente->id}}</td>
                                                        ...
                                                        <td><a href="{{ route('cliente.show', $cliente->id) }}" target="_blank"><button type="button" class="btn btn-s-m btn-primary"><i class="fa fa-eye"></i></button></a>
