...
@section('content')
                                        ...
                                        <table class="table table-striped table-bordered dataTables-egreso">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        @canany(['guia_egreso.anular', 'guia_egreso.procesar']) Acciones
                                                        @endcan
                                                    </th>
                                                    <th>Información</th>
                                                </tr>
                    ...
                    <div class="row" align="center">
                        <div class="col-sm-12 b-r">
                            ...
                            <form id="formulario_anular"
                                action="{{ route('garantia_guia_egreso.anular_guia_egreso', ':id') }} "
    ...
    <script>
        $(document).ready(function() {
                        ...
                        'render': function(data, type, full, meta) {
                            ...
                            if (permiso_procesar) {
                                ...
                                if (full[10] == 1 && full[12] == 0) {
                                    var url =
                                        '{{ route('garantia_informe_tecnico.create_tecnico', ':id') }}'
                                    url = url.replace(':id', full[0]);
                                    html_fin +=
                                        `<a href="${url}"><button type="button" class="btn btn-info btn-sm"><i class="fa fa-sign-in"></i></button>`;
                                } else {
                                    html_fin +=
                                        `<a href="#"><button type="button" class="btn btn-default btn-sm disabled" style="background-color:gray;"><i class="fa fa-sign-in"></i></button>`;
                                }
                            }
                            html_fin += `</div>`
                            return html_fin;
            ...
            $(document).on('ifChecked ifUnchecked', '.dataTables-egreso thead input[type="checkbox"]', function(
                event) {
                    ...
                    if (totalRows > 50) {
                        swal({
                            ...
                            if (isConfirm) {
                                ...
                                $('.dataTables-egreso thead input[type="checkbox"]').iCheck(
                                    'uncheck');
                            }
                        });
                    } else {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        success: function(blob) {
                            ...
                            a.href = url;
                            a.download =
                                `Garantia_Guias_Egresos_${new Date().toISOString().slice(0,10)}.xlsx`;
            ...
            $('#btn-correo-filtrado').on('click', function(e) {
                ...
                swal({
                    ...
                    text: `Ingresa el correo electrónico para enviar ${selectedIds.length} guía(s) de egreso:`,
                    type: "input",
                    showCancelButton: true,
                    ...
                    swal({
                        title: "Enviando...",
                        text: `Procesando ${selectedIds.length} guía(s) de egreso. Por favor espera...`,
                        showConfirmButton: false,
                    ...
                    // Enviar por AJAX
                    $.ajax({
                        url: '{{ route('envioCorreo.garantia_guia_egreso.multiple') }}',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            email: inputValue,
                            ...
                            if (response.success) {
                                swal({
                                    ...
                                    text: response.message ||
                                        `Se han enviado ${selectedIds.length} guía(s) de egreso por correo`,
                                    type: "success",
                                    timer: 3000,
