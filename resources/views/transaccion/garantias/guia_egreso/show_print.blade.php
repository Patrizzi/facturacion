                ...
                <div class="row" style="height: auto;">
                    <div class="col-sm-4 text-left" align="left">
                        <div class="form-control" align="center"
                            style="height: 100%;vertical-align: middle;align-items: center;display: inline-flex;justify-content: center;"
                            align="left">
                            <img align="center" src="{{ asset('img/logos/' . $mi_empresa->foto) }}"
                    ...
                    <div class="col-sm-4" align="center">
                        <div class="form-control" align="center"
                            ...
                            align="center">
                            <img align="center"
                                src="{{ asset('archivos/imagenes/marcas/' . $garantias_guias_egreso->garantia_ingreso_i->marcas_i->imagen) }}"
        ...
        <div class="col-sm-6">
            <center>
                <p style="width: 50%;border-top: 1px solid #aaaaaa">
                    Departamento de Servicio Técnico <br> Ing.
                    {{ $garantias_guias_egreso->garantia_ingreso_i->personal_laborales->nombres }}
                    {{ $garantias_guias_egreso->garantia_ingreso_i->personal_laborales->apellidos }}
                </p>
            </center>
        </div>
        <div class="col-sm-6">
