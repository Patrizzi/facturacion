                        ...
                        <div class="col-sm-6" align="center">
                            <div class="form-control">
                                ...
                                <div align="left" class="row" style="padding-right:10px; padding-left: 10px;">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="asunto" value="Ingreso de Equipo"
                                            required />
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" value="{{ $tiempo_actual }}" readonly>
                                    </div>

                                    <label class="col-sm-2 col-form-label"><strong>Cliente:</strong></label>
                                    <div class="col-sm-10" style="display: flex; align-items: center;">
                                        <select class="select2_demo_3 form-control" onchange="buscador_contac();"
                            ...
                            <div class="form-control ">
                                ...
                                <div align="left" class="row" style="padding-right:10px; padding-left: 10px;">
                                    ...
                                    <div class="col-sm-10" id="father_producto" style="display: flex; align-items: center;">
                                        <select class="select2_demo_2 form-control" name="nombre_equipos" required
                                            id="producto">
                                    ...
                                    <div class="col-sm-10" id="father_servicio" style="display: none">
                                        <select class="select2_demo_serv form-control" name="invalido" id="servicio_t">
                                            @foreach ($servicios as $servicio)
                                                <option value="{{ $servicio->nombre }}">{{ $servicio->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <label class="col-sm-2 col-form-label"><strong>N° Serie:</strong></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="numero_serie" value="0"
                                            required>
                                    </div>
                                    <label class="col-sm-2 col-form-label"><strong>Cod. interno</strong></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="codigo_interno" value="000000"
                                            required>
                                    </div>
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" id="tab-1" class="tab-pane active">
                                                        <div class="panel-body">
                                                            <textarea class="form-control" rows="10" placeholder="Escribir aquí Descripción Del Problema"
                                                                name="descripcion_problema" maxlength="1230" required></textarea>
                                                        </div>
                                                    </div>
                                                    <div role="tabpanel" id="tab-2" class="tab-pane">
                                                        <div class="panel-body">
                                                            <textarea class="form-control" rows="10" placeholder="Escribir aquí Revisión y diagnostico"
                                                                name="revision_diagnostico" maxlength="1230" required></textarea>
                                                        </div>
                                                    </div>
                                                    <div role="tabpanel" id="tab-3" class="tab-pane">
                                                        <div class="panel-body">
                                                            <textarea class="form-control" rows="10" placeholder="Escribir aquí Estética" name="estetica" maxlength="1230"
                                                                required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
