        ...
        <table style="width: 100%;border-collapse:separate">
            <tr>
                ...
                <td style="width: 29%; ;border: 1px #3D3D3D solid;border-radius: 8px;margin: 2px 0px;vertical-align: middle" align="right">
                    <center><img align="" src="{{asset('archivos/imagenes/marcas/'.$garantia_guia_ingreso->marcas_i->imagen)}}" style="height: 50px;width: 150px;margin-top: 5px" /></center>
                </td>
                <td style="width: 6%;border-color: transparent"></td>
        ...
        <table style="width: 100%;border-collapse:separate">
            <tr>
                <td colspan="2" style="border: 1px #3D3D3D solid;border-radius: 4px;width: 47%" >
                    ...
                    <strong>{{$garantia_guia_ingreso->clientes_i->documento_identificacion}}:</strong>&nbsp;{{$garantia_guia_ingreso->clientes_i->numero_documento}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Fecha:</strong>&nbsp;{{date("d/m/Y", strtotime($garantia_guia_ingreso->fecha))}}<br>
            ...
            <tr>
                <td style="border: 1px #3D3D3D solid;border-radius: 4px;width: 100%;">    
                    <table style="border-color: white;">
                        ...
                        <tr>
                            <td style="border-color: white;padding: 0px;width: 50%;"><strong>Modelo:</strong>&nbsp;{{$garantia_guia_ingreso->nombre_equipo}}</td>
                            <td style="border-color: white;padding: 0px;width: 50%"><strong>Codigo Interno:</strong>&nbsp;{{$garantia_guia_ingreso->codigo_interno}}</td>
                        </tr>
                        <tr>
                            <td style="border-color: white;padding: 0px;width: 50%"><strong>Número de Serie:</strong>&nbsp;{{$garantia_guia_ingreso->numero_serie}}</td>
                            <td style="border-color: white;padding: 0px;width: 50%"><strong>Fecha de Compra:</strong>&nbsp;<span>{{date("d/m/Y", strtotime($garantia_guia_ingreso->fecha_compra))}}</span></td>
                        </tr>
                    </table>
