                            ...
                            <div class="card p-3" style="border: none;">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text" style="font-size: 14px">
                                        {{ $count_mounth['g_ingreso_month_count'] }} Documentos</p>
                                    <p class="card-text"><small class="text-body-secondary" style="font-size: 12px">Ultima
                                            actualización:
                                            <strong>{{ $count_mounth['g_ingreso_last_update'] }}</strong></small></p>
                                </div>
                            </div>
                        @endcan
                        @can('guia_egreso.listar')
                            <div class="card p-3" style="border: none;">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text" style="font-size: 14px">{{ $count_mounth['g_egreso_month_count'] }}
                                        Documentos</p>
                                    <p class="card-text"><small class="text-body-secondary" style="font-size: 12px">Ultima
                                            actualización:
                                            <strong>{{ $count_mounth['g_egreso_last_update'] }}</strong></small></p>
                                </div>
                            </div>
                        @endcan
                        @can('informe_tecnico.listar')
                            <div class="card p-3" style="border: none;">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text" style="font-size: 14px">
                                        {{ $count_mounth['i_tecnico_month_count'] }} Documentos</p>
                                    <p class="card-text"><small class="text-body-secondary" style="font-size: 12px">Ultima
                                            actualización:
                                            <strong>{{ $count_mounth['i_tecnico_last_update'] }}</strong></small></p>
                                </div>
                            </div>
                        @endcan
                    </div>
