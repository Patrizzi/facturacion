                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($boleta_registro as $e => $boleta_registros)
                                                        <tr>
                                                            ...
                                                            @endif
                                                            <td><input readonly type="text" class="form-control" value="{{ $boleta_registros->cantidad }}" name="" id=""></td>
                                                            <td>
                                                                <input required="required" class="form-control"
                                                                    type="text"
                                                            ...
                                                            @if ($tipo == 'boleta_origi')
                                                                <td><input type="text" readonly value="{{ $boleta_registros->precio_unitario_comi }}" name="" id=""></td>
                                                                {{-- Precio Unitario --}}
                                                            ...
                                                            @else
                                                                <td><input type="text" readonly value="{{ $boleta_registros->precio }}" class="form-control" name="" id=""></td>
                                                                {{-- Precio Unitario --}}
                                                                <td><input required="required" class="form-control"
                                                                        type="text"
                                                                        id="input_precio_{{ $e }}"
                                                            ...
                                                            @if ($tipo == 'boleta_origi')
                                                                <td><input type="text" value="{{ $boleta_registros->precio_unitario_comi * $boleta_registros->cantidad }}" class="form-control" readonly name="" id="">
                                                                </td> {{-- Total --}}
                                                            @else
                                                                <td><input type="text" value="{{ $boleta_registros->precio * $boleta_registros->cantidad }}" readonly class="form-control" name="" id="">
                                                                </td> {{-- Total --}}
                                                            @endif
