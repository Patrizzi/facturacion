                            ...
                            <div class="col-sm-6" align="center">
                                <div class="form-control">
                                    ...
                                    <div align="left">
                                        ...
                                        <input required="required" class="form-control" type="text" id="nueva_boleta"
                                            name="nueva_boleta" value="{{ $nueva_boleta }}" readonly style="display: none">
                                        {{ $nueva_boleta }} <br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input required="required" class="form-control" type="text"
                                                ...
                                                value="{{ $boleta_registros->cantidad }}" readonly>
                                        </td>
                                        <td>
                                            @if (isset($boleta_registros->producto_id))
                                                <input required="required" class="form-control" type="text"
                                                    ...
                                                    value="{{ $boleta_registros->producto->nombre }}" readonly>
                                            @elseif(isset($boleta_registros->servicio_id))
                                                <input required="required" class="form-control" type="text"
                                                    id="input_descripcion_{{ $e }}"
                                                    name="input_descripcion_{{ $e }}"
                                                    value="{{ $boleta_registros->servicio->nombre }}" readonly>
                                            @endif
                                        </td>
                                        @if ($tipo == 'boleta_origi')
                                            ...
                                            <td><input required="required" class="form-control" type="text"
                                                    ...
                                                    value="{{ $boleta_registros->precio_unitario_comi }}" readonly></td>
                                            {{-- Nuevo Precio --}}
                                        @else
                                            ...
                                            <td><input required="required" class="form-control" type="text"
                                                    id="input_precio_{{ $e }}"
                                                    name="input_precio_{{ $e }}"
                                                    value="{{ $boleta_registros->precio }}" readonly></td>
                                            {{-- Nuevo Precio --}}
                                        @endif
                                        <td>
                                            <input required="required" class="form-control" type="text"
                                                id="input_descuento_{{ $e }}"
                                                name="input_descuento_{{ $e }}" value="0" readonly>
                                        </td>
                                        @if ($tipo == 'boleta_origi')
                                            <td>{{ $boleta_registros->precio_unitario_comi * $boleta_registros->cantidad }}
                                            </td> {{-- Total --}}
                                        @else
                                            <td>{{ $boleta_registros->precio * $boleta_registros->cantidad }}</td>
                                            {{-- Total --}}
                                        @endif
                ...
                <div class="ibox">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading text-center">
                            <h2><strong>{{ $boleta->codigo_boleta }}Descuento Global</strong></h2>
                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">
                                                                <strong>
                                                                    @if ($boleta->cliente->documento_identificacion == 'RUC')
                                                                        R.U.C:
                                                                    @else
                                                                        DNI:
                                                                    @endif
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input required="required" class="form-control"
                                                                    ...
                                                                    value="Descuento Global" readonly />
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <tr>
                                                            ...
                                                            @else
                                                                ...
                                                                <td><input required="required" class="form-control"
                                                                        ...
                                                                        id="input_precio_{{ $e }}"
                                                                        name="input_precio_{{ $e }}"
                                                                        value="{{ $boleta_registros->precio }}" readonly>
                                                                </td> {{-- Nuevo Precio --}}
                                                            @endif
                                                            <td>
                                                                <input required="required" class="form-control"
                                                            ...
                                                            @else
                                                                <td>{{ $boleta_registros->precio * $boleta_registros->cantidad }}
                                                                </td> {{-- Total --}}
                                                            @endif
                                                            <td style="display: none">
                                                                {{ $sub_total = $boleta_registros->boleta_i->op_gravada + $boleta_registros->boleta_i->op_inafecta + $boleta_registros->boleta_i->op_exonerada }}
