                    ...
                    <div class="ibox-content">
                        <div class="panel panel-success">
                            <div class="panel-heading text-center">
                                <h2><strong>Anulación de Operación</strong></h2>
                            </div>
                            <form action="{{route('nota-credito.store_boleta',$boleta->id)}}"  enctype="multipart/form-data" method="post" >
                                @csrf
                                <div class="col-lg-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-4 col-form-label"><strong>Tipo:</strong></label>
                                                                        <div class="col-sm-8">
                                                                            <input required="required" class="form-control" type="text" id="motivo" name="motivo" value="Anulación de la operación" readonly />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
