                ...
                <div class="ibox">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading text-center">
                            <h2><strong>{{ $boleta->codigo_boleta }} - Anulación por error de RUC </strong></h2>
                        </div>
                                ...
                                <div class="ibox">
                                    <div class="ibox-content">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label"><strong>Nueva
                                                                    Bolete M. Electrónica:</strong></label>
                                                            <div class="col-sm-8">
                                                                <input required="required" class="form-control"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($boleta_registro as $e => $boleta_registros)
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control" readonly
                                                                    value="{{ $boleta_registros->cantidad }}"></td>
                                        ...
                                        <div class="text-center" style="margin-top: 20px;">
                                            <button type="submit" class="ladda-button btn btn-success" data-style="expand-right"><span class="ladda-label">Guardar</span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
