        ...
        <div class="col-lg-12">
            <div class="ibox">
                    ...
                    <div class="container col-lg-12">
                        <div class="panel panel-success">
                            <div class="panel-heading text-center">
                                <h2><strong>Motivo de Nota de {{$facturacion->codigo_fac}}</strong></h2>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label"><strong>Número de FE:</strong></label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="factura_id" id="factura_id" required value="{{$facturacion->codigo_fac}}" readonly/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="nueva_factura" id="nueva_factura">
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                ...
                                <div class="text-center mt-4">
                                    <button type="button" class="btn btn-success" type="submit">Enviar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container col-lg-12">
                    <div class="panel panel-success">
                        <div class="panel-heading text-center">
                            <h2><strong>Motivo de Nota de {{$facturacion_m->codigo_fac}}</strong></h2>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="factura_id" id="factura_id" required value="{{$facturacion_m->codigo_fac}}" readonly/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-5 col-form-label"><strong>Tipo:</strong></label>
