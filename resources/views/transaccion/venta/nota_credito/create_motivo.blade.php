...
@section('content')
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="factura_id"
                                                            id="factura_id" required
                                                            value="{{ $facturacion->codigo_fac }}" readonly />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="sustento" class="col-sm-5 col-form-label"><strong>Tipo:</strong></label>
                                                    <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" class="form-control"
                                                                name="nueva_factura" id="nueva_factura">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="factura_id"
                                                            id="factura_id" required
                                                            value="{{ $facturacion_m->codigo_fac }}" readonly />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="sustento" class="col-sm-5 col-form-label"><strong>Tipo:</strong></label>
                                        ...
                                        <option value="9">Ajustes - montos y/o fechas de pago</option> --}}
                                                ...
                                                <div class="div2">
                                                    <div class="form-group row">
                                                        <label class="col-sm-5 col-form-label" for="nueva_factura"><strong>Número
                                                                Nuevo:</strong></label>
                                                        <div class="col-sm-7">
                                                            <input type="text" class="form-control"
                                                                name="nueva_factura" id="nueva_factura">
    ...
    <script>
        ...
        function seleccion_motivo() {
            ...
            $('#nueva_factura').attr('required', false);
            if (motivo == "") {
                $('.div1').hide();
                $('.div2').hide();
                $('.div3').hide();
                ...
                $('#nueva_factura').attr('required', true);
            }
        }
