        ...
        <div class="ibox">
            <div class="ibox-title d-flex justify-content-between" style="padding-right: 3.1%">
                <span class="dropdown" style="margin-top: 5px;margin-bottom: 8px;margin-left: 10px">
                    <a id="dropdownTipoNotaCredito" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
            ...
            <div class="ibox-content" style="padding-right: 3.1%;padding-left: 3.1%; padding-bottom: 10px;">
                <div class="row align-items-center">
                    <div class="col-12 col-md-3">
                        <h3 style="margin: 0;">{{ $notas_credito->codigo_n_c }}</h3>
                    ...
                    <div class="col-12 col-md-5 d-flex flex-wrap justify-content-end align-items-center" style="gap: 4px;">
                        <form class="btn" style="padding: 0;"
                            action="{{ route('nota_credito.pdf', $notas_credito->id) }}">
                            <input type="text" name="name" maxlength="50" hidden
                                value="{{ $notas_credito->codigo_n_c }}">
                        ...
                        <a class="btn btn-success" href="{{ route('nota_credito.print', $notas_credito->id) }}"
                            target="_blank" data-toggle="tooltip" data-placement="bottom" data-original-title="Imprimir">
                            <i class="fa fa-print fa-lg"></i>
                        </a>

                        @if (Auth::user()->email_creado == 1)
                            <form action="{{ route('email.nota_credito', $notas_credito->id) }}" method="post"
                        ...
                        <div id="div-mostrar" style="height: 0px; overflow: hidden; width: 100%; transition: height .4s;">
                            <form action="{{ route('agregado.whatsapp_send') }}" method="post" class="btn"
                                ...
                                <input type="tel" name="numero"
                                    value="{{ $notas_credito->cliente_obj->celular ?? '' }}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-control">
                            ...
                            <span style="display: block;float: right">{{ $simbologia }}
                                {{ number_format($notas_credito->op_gravada, 2) }}</span><br>
                            <span style="display: block;float: left"> Op. Inafecta: </span>
                            <span style="display: block;float: right">{{ $simbologia }}
                                {{ number_format($notas_credito->op_inafecta, 2) }}</span><br>
                            <span style="display: block;float: left"> Op. Exonerada: </span>
                            <span style="display: block;float: right">{{ $simbologia }}
                                {{ number_format($notas_credito->op_exonerada, 2) }} </span><br>
