                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input required="required" class="form-control" type="text"
                                                id="input_cantidad_1" name="input_cantidad_1" value="1" readonly></td>
                                        {{-- Cantidad Nueva --}}
                                        <td><input required="required" class="form-control" type="text"
                                                id="input_descripcion_1" name="input_descripcion_1"
                                                value="{{ $sustento }}" readonly></td> {{-- Descripcion --}}
                                        <td>{{ $descuento_global }}</td> {{-- Precio Unitario --}}
                                        <td><input required="required" class="form-control" type="text"
                                                id="input_precio_1" name="input_precio_1" value="{{ $descuento_global }}"
                                                readonly></td> {{-- Nuevo Precio --}}
                                        <td><input required="required" class="form-control" type="text"
                                                id="input_descuento_1" name="input_descuento_1" value="0" readonly>
                                        </td> {{-- Nuevo Descuento --}}
