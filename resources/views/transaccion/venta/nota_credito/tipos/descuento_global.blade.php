                            ...
                            <tbody>
                                ...
                                <tr>
                                    <tr>
                                        ...
                                        <td>0</td> {{--Cantidad--}}
                                        <td><input required="required" class="form-control" type="text" id="input_cantidad_1" name="input_cantidad_1" value="1" readonly></td> {{--Cantidad Nueva--}}
                                        <td><input required="required" class="form-control" type="text" id="input_descripcion_1" name="input_descripcion_1" value="{{$sustento}}" readonly></td> {{--Descripcion--}}
