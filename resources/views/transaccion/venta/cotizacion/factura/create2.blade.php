                  ...
                  <div class="dropdown" style="float:right;">
                    ...
                    <div class="dropdown-content" align="left">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="forma_pago">Forma de Pago</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" onclick="ConfiguracionSelector(this)"  id="tipo_operacion" @foreach($config as $comision) @if($comision->nombre=='tipo_operacion_create' && $comision->estado=='1') checked @endif @endforeach >
                            <label class="form-check-label" for="tipo_operacion">Tipo Operacion</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" onclick="ConfiguracionSelector(this)"  id="moneda" @foreach($config as $comision) @if($comision->nombre=='moneda_create' && $comision->estado=='1') checked @endif @endforeach >
                            <label class="form-check-label" for="moneda">Cambio de Moneda</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="ibox">
        <div class="ibox-content">
          ...
          <div class="form-group row">
            ...
            <label @foreach($config as $comision)  @if($comision->nombre=='comisionista_create' && $comision->estado=='0')  hidden="hidden" @endif  @endforeach id="comisionista_1"  class="col-sm-1 col-form-label">Comisionista:</label>
            <div class="col-sm-5" id="comisionista_2"  @foreach($config as $comision) @if($comision->nombre=='comisionista_create' && $comision->estado=='0') hidden @endif @endforeach  >
            ...
            {{-- <div id="forma_pago_view"> --}}
                <label  @foreach($config as $comision) @if($comision->nombre=='forma_pago_create' && $comision->estado=='0') hidden @endif @endforeach id="forma_pago_1" class="col-sm-1 col-form-label" >F.Pago:</label>
                <div class="col-sm-5" id="forma_pago_2"  @foreach($config as $comision) @if($comision->nombre=='forma_pago_create' && $comision->estado=='0') hidden @endif @endforeach>
            ...
            {{-- <div id="moneda_view"> --}}
                <label  @foreach($config as $comision) @if($comision->nombre=='moneda_create' && $comision->estado=='0') hidden @endif @endforeach id="moneda_1" class="col-sm-1 col-form-label">Moneda:</label>
                <div class="col-sm-5" id="moneda_2" @foreach($config as $comision) @if($comision->nombre=='moneda_create' && $comision->estado=='0') hidden @endif @endforeach >
                    <div class="row">
            ...
            {{-- <div id="tipo_operacion_view"> --}}
                <label  @foreach($config as $comision) @if($comision->nombre=='tipo_operacion_create' && $comision->estado=='0') hidden @endif @endforeach id="tipo_operacion_1" class="col-sm-1 col-form-label">T.Operación:</label>
                <div class="col-sm-5" id="tipo_operacion_2" @foreach($config as $comision) @if($comision->nombre=='tipo_operacion_create' && $comision->estado=='0') hidden @endif @endforeach >
