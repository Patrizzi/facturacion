        ...
        <div class="row form-label word-style">
            <div class="col-md-6">
                <div class="form-group row d-flex align-items-center">
                    <label class="col-lg-2 col-md-3 col-form-label">Cliente<span class="required">*</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row d-flex align-items-center">
                            <label class="col-lg-4 col-form-label">T.Cotización<span class="required">*</label>
                            <div class="col-lg-8">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row d-flex align-items-center">
                            <label class="col-lg-5 col-form-label">Forma de Pago<span class="required">*</label>
                            <div class="col-lg-7">
                                <select class="form-control" name="forma_pago" required="required">
                                    @foreach($forma_pagos as $forma_pago)
                                        <option value="{{$forma_pago->id}}">{{$forma_pago->nombre}} </option>
                ...
                <div class="form-group row d-flex align-items-center">
                    <label class="col-lg-2 col-form-label">Comisionista<span class="required">*</label>
                    <div class="col-lg-10">
                        <input list="browsersc2" class="form-control" id="comisionista" name="comisionista" required value="Sin comision - 0" onkeyup="comision()" autocomplete="off">
                        <datalist id="browsersc2" >
                            <option id="">Sin comision - 0 </option>
            ...
            <div class="col-md-6">
                <div class="form-group row d-flex align-items-center">
                    <label class="col-lg-2 col-md-3 col-form-label">T.Operación<span class="required">*</label>
                    <div class="col-lg-10 col-md-9">
                        <select class="form-control" name="tipo_operacion" >
                            @foreach($tipo_operacion as $t_op)
                            <option id="{{$t_op->id}}">{{$t_op->codigo}} - {{$t_op->informacion}}</option>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row d-flex align-items-center">
                            <label class="col-lg-4 col-form-label">Garantía<span class="required">*</label>
                            <div class="col-lg-8">
                                <select class="form-control" name="garantia">
                                    @foreach($garantia as $garantias)
                                        <option value="{{$garantias->descripcion}}">{{$garantias->descripcion}}</option>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row d-flex align-items-center">
                            <label class="col-lg-4 col-form-label">Validez<span class="required">*</label>
                            <div class="col-lg-8">
                                <select  class="form-control" name="validez" required="required">
                                    @foreach($validez as $validezz) <option value="{{$validezz->descripcion}}">{{$validezz->descripcion}}</option> @endforeach
                                </select>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row d-flex align-items-center">
                            <label class="col-lg-4 col-form-label">F. Emisión<span class="required">*</label>
                            <div class="col-lg-8">
