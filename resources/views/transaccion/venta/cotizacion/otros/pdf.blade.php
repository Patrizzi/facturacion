...
<table style="width: 100%;border-collapse:separate;margin-bottom: -10px">
    <tr>
        <td style="width: 35%;border-color: white" rowspan="2" valign="top">
            <img align="" src="{{asset('img/logos/')}}/{{$empresa->foto}}" style="margin-top: 0px;" width="300px" />
            <br>
        </td>
        <td style="width: auto;border-color: white;text-align:center !important;" rowspan="2" valign="top">
     ...
     <td style="width: 30%; ;border: 1px #e5e6e7 solid;border-radius: 8px;margin-top: 0px" align="right">
        <center>
            ...
            <h5 style="text-align: center;margin-bottom: -5px" >CO001-0000000{{$codigo}}</h5>
        </center>
    </td>
</tr>
</table>
        ...
        <table class="table " style="border-top: 0px" >
            <thead align="left">
               <tr style="text-align: left;font-weight: bold;border-top-width:  0px ">
                ...
                <th   style="text-align:center;">Total <span hidden="hidden">{{$moneda_id->simbolo}}</span></th>
            </tr>
        </thead>
        <tbody align="left">
...
<table  style="width: 100%;border-collapse:collapse;margin-bottom: -10px">
   <tr>
      ...
      <td   style="width: auto; ;border: 1px #e5e6e7 solid;border-top-left-radius: 8px 0 0 8px;margin-top: 0px;border-left: none;border-collapse:collapse;" align="right">
          @if($tipo_coti==1)
          <span>{{$simbologia=$moneda_id->simbolo}}{{$sub_total=round($costo_total/1.18,2)}} </span><br>
          <span>{{$simbologia}}{{round($sub_total*0.18,2)}}</span><br>
          @endif
          <span>{{$moneda_id->simbolo}} {{$costo_total}}</span><br>
