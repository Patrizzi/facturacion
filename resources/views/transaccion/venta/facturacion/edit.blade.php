<div class="row">
    <div class="col-lg-12" style="margin-top: -5px;">
        <div class="ibox-content p-xl" style=" margin-bottom: 20px;padding-bottom: 50px;">
            <form action="{{ route('facturacion.update', $facturacion->id) }}" enctype="multipart/form-data" id="form_update"
                method="post">
                @csrf
                            ...
                            <div class="col-md-10">
                                ...
                                @else
                                    ...
                                    <input type="hidden" name="" id="comisionista"
                                        value="{{ $facturacion->select_comisionista->comision }}">
                                @endif
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <input type="text" name="" id="" class="form-control"
                                    id="nombre_vendedor" readonly value="{{ $facturacion->user->name }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <input type="hidden" name="n_registros_ori[]" id="n_registros_ori" value="existente"> --}}
                                    ...
                                    <td class="td_selected">
                                        <select class="monto{{ $i_edit }} select2_demo_3 select_change"
                                            ...
                                            @if ($registros->producto->id)
                                                ...
                                                @php
                                                    ...
                                                    $input_prod =  $registros->producto->id.' | '.$registros->producto->codigo_producto.' | '.$registros->producto->codigo_original.' | '.$registros->producto->nombre ;
                                                    $afect = explode(' - ', $registros->producto->tipo_afec_i_producto->informacion)[0];
                                                @endphp
                                            @else
                                                <option
                                                ...
                                                @php
                                                    $stock_actual = 1000;
                                                    $input_prod = $registros->servicio->id.' | '.$registros->servicio->codigo_servicio.' | '.$registros->servicio->codigo_original.' | '.$registros->servicio->nombre;
                                                    $afect = explode(' - ', $registros->servicio->tipo_afec_i_serv->informacion)[0];
                                                @endphp
                                            @endif
                                        </select>
                                        <textarea type='text' id='descripcion{{ $i_edit }}' name='descripcion_item[]'
                                            placeholder="Descripción de Item" class="form-control" autocomplete="off" style="margin-top: 5px;">{{ $registros->descripcion_item }}</textarea>
                                        ...
                                        <input style="width: 76px" hidden="" type='text'
                                    ...
                                    <td>
                                        <input style="min-width: 80px;margin: 0px" type='text'
                                            id='stock{{ $i_edit }}' readonly="readonly" name='stock[]'
                                    ...
                                    <td>
                                        <input style="min-width: 85px" type='text' id='precio{{ $i_edit }}'
                                    ...
                                    <td>
                                        <div style="position: relative;">
                                            <input class="text_des" type='text' id='descuento{{ $i_edit }}'
                                                name='descuento[]' readonly="readonly" class="" required
                                                autocomplete="off" value="{{ $registros->descuento }}" />
                                        </div>
                                        <div class="div_check">
                                            @if ($registros->descuento == 0)
                                                ...
                                                <input type='hidden' id='check_descuento{{ $i_edit }}'
                                                    name='check_descuento[]' class="form-control" required value="0">
                                            ...
                                            @else
                                                <input class="check" type='checkbox' id='check{{ $i_edit }}'
                                                    ...
                                                    style="" autocomplete="off" />
                                                <input type='hidden' id='check_descuento{{ $i_edit }}'
                                                    name='check_descuento[]' class="form-control" required value="{{$registros->descuento}}">
                                    ...
                                    <td>
                                        <input style="min-width: 85px" type='text' id='total{{ $i_edit }}'
                                            name='total' disabled="disabled" class="total form-control" required
                                            autocomplete="off"
                                            value="{{ $registros->precio_unitario_comi * $registros->cantidad }}" />
