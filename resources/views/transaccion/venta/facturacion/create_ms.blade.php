                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="monto0 select2_demo_3 select_change"  required="" id="articulo"  onchange="calcular(this,0);multi(0);selet_one()"  autocomplete="off">
                                                            ...
                                                            {{-- <input type="text" class="celda2"  name="articulo2[]" id="input_prod2" > --}}
                                                        </td>
