        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{ route('facturacion.store', $moneda->id) }}" enctype="multipart/form-data"
                            ...
                            <div class="col-sm-4">
                                <div class="form-control ruc tooltip-demo" style="height:125px">
                                    <center>
                                        ...
                                        <h4>{{ $factura_numero }} <span class="small" data-toggle="tooltip"
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <input list="browsersc2" class="form-control m-b" id="comisionista"
                                            name="comisionista" required value="Sin comision - 0" onkeyup="comision()"
                                            autocomplete="off">
                                            ...
                                            @foreach ($p_venta as $p_ventas)
                                                <option id="{{ $p_ventas->id }}">{{ $p_ventas->cod_vendedor }} -
                                                    {{ $p_ventas->personal->personal_l->nombres }} - <span
                                                        style="color: red">{{ $p_ventas->comision }}</span></option>
                                            @endforeach
                                        </datalist>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>:</td>
                                    {{-- <td><input type="text" class="form-control m-b" name="orden_compra" required
                                            autocomplete="off" value="0"></td> --}}
                                    <td>Guía de Remisión <small class="tooltip-demo"><i class="fa fa-info-circle"
                                ...
                                <tr>
                                    <td>Vendedor</td>
                                    <td>:</td>
                                    <td><input type="text" class="form-control" name="personal" disabled
                                            required="required" value="{{ auth()->user()->name }}"></td>
                                    <td>Forma de pago</td>
                                    <td>:</td>
                                    <td>
                                        {{-- <div class="row">
                                            ...
                                            <div class="col-sm-6" id="credito_pago" style="visibility: hidden;">
                                                <button type="button" class='cuota_modal btn btn-info' id="cuota_modal"
                                                    data-toggle="modal" data-target="#cuotas_modal">Cuotas</button>
                                            </div>
                                        </div> --}}
                                    </td>
                                    {{-- <!-- Modal de Cuotas -->
                                    <div class="modal fade bd-example-modal-lg" id="cuotas_modal" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Registrar cuotas
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert alert-danger alert-dismissible fade show"
                                                        role="alert" id="alert_campos" style="display: none">
                                                        <strong style="font-size:11px">Rellenar todos los
                                                            campos</strong>
                                                        <button type="button" class="close_model_rc close"
                                                            onclick="cerrar_but_rc()" style="padding: 6;">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="alert alert-danger alert-dismissible fade show"
                                                        role="alert" id="suma_campos" style="display: none">
                                                        <strong style="font-size:11px">La suma de las cuotas es
                                                            diferente del monto total</strong>
                                                        <button type="button" class="close_model_mt close"
                                                            onclick="cerrar_but_mt()" style="padding: 6;">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                        ...
                                                        <div class="pago_modal row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="date" name="fecha_pago[]"
                                                                    id="fecha_pago0" min="{{ $fecha_1 }}"
                                                                    class="fecha_pago form-control">
                                                            </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="input-group mb-3"
                                                                    ...
                                                                    <input type="text" name="monto_pago[]"
                                                                        id="monto_pago0"
                                                            ...
                                                            <div class="col-sm-2">
                                                                <label><button type="button" aria-hidden="true"
                                                                        id="add_pago"
                                ...
                                <tr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" name="moneda" id="moneda"
                                                    class="form-control " value="{{ $moneda->nombre }}"
                                                    readonly="readonly">
                                            </div>

                                            <a class="col-sm-5 button_money" onclick="changeMoney()">
                                                <button style="height: 35px;width: auto" type="button"
                                                    class='money_change btn btn-info' id="button_changeMoney">
                                    ...
                                    <td>Fecha</td>
                                    <td>:</td>
                                    <td><input type="text" name="fecha_emision" class="form-control"
                                            value="{{ date('d-m-Y') }}" readonly="readonly"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td id="ven_3p" style="visibility: initial;"><input type="date"
                                            name="fecha_vencimiento" id="fecha_vencimiento" class="form-control"
                                            value="{{ date('Y-m-d') }}"></td>
                                </tr>
                                <tr>
                                    <td>Detracción</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type='text' id='afectacion0' style="min-width: 76px"
                                                ...
                                                class="afectacion form-control " hidden="" autocomplete="off" />
                        ...
                        <button type="button" class='addmore btn btn-success' disabled=""> <i
                                class="fa fa-plus-square" aria-hidden="true"></i> </button>&nbsp;
                        <button class="ladda-button btn btn-primary float-right" type="button" id="boton"
                            name="boton"><i class="fa fa-cloud-upload" aria-hidden="true">
                                Guardar</i></button>&nbsp;
                    ...
                    {{-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_detraccion">
                        Launch demo modal
                    </button> --}}
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="row col-lg-12">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 col-form-label"><strong>Orden de
                                                Compra:</strong></label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control m-b" name="orden_compra"
                                                required autocomplete="off" value="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-5 col-form-label"><strong>Guía de
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6" id="credito_pago" style="visibility: hidden;">
                                                    <button type="button" class='cuota_modal btn btn-info'
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="moneda" id="moneda"
                                                class="form-control " value="{{ ucwords($moneda->nombre) }}"
                                                readonly="readonly">
                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <textarea id="Descripcion" name="Descripcion" class="form-control" autocomplete="off"
                                                        placeholder="Descripción de Item" style="margin-top: 5px;"></textarea>
                                                    <textarea id="Serie" name="Serie" class="form-control" autocomplete="off" placeholder="Número de Serie"
                                                ...
                                                <td>
                                                    <input type="text" id="precio_unitario_descuento0"
                                                        name="precio_unitario_descuento[]" disabled
                                                        class="precio_unitario_descuento0 form-control" required
                                                        autocomplete="off" />
                                                </td>
                                                <td>
                                                    <input type="text" id="precio_unitario_comision0" disabled
                                                        class="form-control" required autocomplete="off" />
                                                </td>
                                                <td>
                                                    <input type="text" id="total0" name="total" disabled
