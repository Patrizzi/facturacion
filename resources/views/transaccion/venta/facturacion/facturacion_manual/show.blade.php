...
@section('title', 'Facturacion Manual Ver')

@section('href_accion', route('facturacion.index'))
@section('value_accion', 'Atras')

@section('button2', 'Nueva Facturacion Manual')
       ...
       <div class="row">
           ...
           <div class="col-sm-4 form-control">
               {{-- <div class="col-sm-4 form-control" > --}}
                   ...
                   <span style="display: block;float: right">{{$facturacion->moneda->simbolo}} {{number_format(round($end, 2),2)}}</span>
