                ...
                <div class="row form-label word-style">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row d-flex align-items-center">
                            ...
                            <div class="col-lg-9">
                                <select class="select2_demo_client form-control" name="cliente" id="cliente"
                                    required></select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="form-group row d-flex align-items-center">
                                    <label class="col-lg-5 col-form-label">Orden de Compra<span
                            ...
                            <div class="col-md-6">
                                <div class="form-group row d-flex align-items-center">
                                    <label class="col-lg-5 col-form-label">Guía de Remisión<span
                                            class="required">*</span></label>
                                    <div class="col-lg-7">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <div class="form-group row d-flex align-items-center">
                                    <label class="col-lg-6 col-form-label">F. de Pago <span
                                            class="required">*</span></label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row d-flex align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control" name="moneda" required>
                                            <option value="nacional" {{ $moneda->tipo == 'nacional' ? 'selected' : '' }}>
                                                Soles</option>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            <form action="{{ route('facturacion_manual.store') }}" enctype="multipart/form-data"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-control ruc tooltip-demo" style="height:125px">
                                            <center>
                                                ...
                                                <h4 id="codigo_fac_manual">{{ $factura_numero }} <span class="small"
                                                        data-toggle="tooltip" data-placement="bottom"
                                                        title="N° Referencial"><i
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <select class="select2_demo_almacen" name="almacen_id_selec"
                                                    required="" onchange="codigo_numero()">
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td><input type="text" class="form-control m-b" name="orden_compra"
                                                    required autocomplete="off" value="0"></td>
                                            <td>Guía remisión <small class="tooltip-demo"><i class="fa fa-info-circle"
                                                        data-toggle="tooltip" data-placement="bottom"
                                                        title="Ej: TE01-999  *  Mayusculas y separar solo con espacios en blanco"></i></small>
                                            </td>
                                            <td>:</td>
                                            <td>
                                                <input list="guia_list" type="text" class="form-control"
                                                    value="0" name="" id="guia_remi_input"
                                                    autocomplete="off">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6" style="">
                                                                    <label for=""><strong>Precio Total:
                                                                            &nbsp;</strong>{{ $moneda->simbolo }}&nbsp;</label><label
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <input type="hidden" name="almacen" id="_selec"
                                                        class="form-control " value="{{ $sucursal->id }}"
                                                        readonly="readonly">
                                    ...
                                    <table cellspacing="0" class="table tables  ">
                                        ...
                                        <tbody>
                                            <tr style="background-color: #f5f5f500;" align="center">
                                                ...
                                                <td>Subtotal :</td>
                                                <td colspan="2">
                                                    <input id='sub_total' type="number" name="sub_total_sin_igv"
                                                        readonly class="form-control inp" required />
                                            ...
                                            <tr align="center">
                                                ...
                                                <td></td>
                                                <td>Total :</td>
                                                <td colspan="2"><input id='total_final' type="number"
                                                        name="costo_total" readonly="readonly" class="form-control inp"
                                                        required /></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-6 text-right"> <!-- text-right alinea el botón a la derecha -->
                                        <button type="button" name="name" value="pdf"
                                            class="ladda-button btn btn-info" id="boton">Enviar</button>
