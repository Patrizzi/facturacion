...
<body class="white-bg">
    ...
    <div class="wrapper wrapper-content animated fadeIn" style="margin-top: -10px ">
                    ...
                    @foreach ($facturacion_registro as $facturacion_registros)
                        <tr>
                            ...
                            @if (isset($facturacion_registros->producto))
                                <td style="text-align:center;">{{ $facturacion_registros->producto->codigo_producto }}
                                </td>
                            ...
                            @else
                                <td style="text-align:center;">{{ $facturacion_registros->servicio->codigo_servicio }}
                                </td>
        ...
        <footer style="padding-top: 120px">
            ...
            @else
                <table style="width: 100%;border-collapse:separate;margin-top: -20px;margin-bottom: -20px">
                    <tr>
                        <td colspan="2" style="border: 1px #808080 solid;border-radius: 8px;width: auto">
                            <strong>Informacion de Detraccion:</strong><br>
                            <strong>Tipo de Detraccion:</strong>
                            {{ $detraccion->tipo_detraccion->descripcion }} - {{ $detraccion->porcentaje_detraccion }}
                            %<br>
