        ...
        <div class="col-lg-12">
            <div class="ibox-content p-xl" style="margin-bottom:20px; padding-bottom:50px;">
                ...
                <div class="row" align="center" style="padding-bottom:5px">
                    @if ($factura->f_electronica == 2 || ($factura->nota_credito == 1 || $factura->nota_credito == 2 && $factura->motivo == "01"))
                    <div id="watermark">
                        <p>Anulado</p>
                    </div>
                    @endif
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right">{{number_format($factura_registros->precio_unitario_comi * $factura_registros->cantidad,2)}}</td>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-control" style="height:100px !important">
                            ...
                            <strong>Tipo:</strong> {{$detraccion->tipo_detraccion->descripcion}} - {{$detraccion->porcentaje_detraccion}} %<br>
                            <strong>Medio de Pago:</strong> {{$detraccion->medio_pago->descripcion}} <br>
                            <strong>Monto:</strong> S/. {{number_format($detraccion->monto_detraccion, 2)}} <br>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-control" style="height:100px !important">
