                        ...
                        <div class="col-sm-4 ">
                            <div class="form-control ruc tooltip-demo" style="height: 125px">
                                <center>
                                    ...
                                    <h4>{{$codigo_guia}} <span class="small" data-toggle="tooltip" data-placement="bottom" title="N° Referencial"><i class="fa fa-question-circle"></i></span><input type="text" id="almacen_in" name="almacen" value="{{$almacen}}" hidden="hidden"> </h4>
                                </center>
                            </div>
                        </div>
                    </div><br>
