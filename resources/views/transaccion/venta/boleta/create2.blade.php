                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control">
                                            ...
                                            <option value="">BOX PARTS SOCIEDAD ANONIMA CERRADA | 20605675523
                                            </option>
                                            <option value="">CELESTE DEL CARMEN UGARTE HUACCHILLO | 72875303
                                            </option>
                    ...
                    <div class="row ">
                        <div class="col-sm-12">
                            <div style="margin: auto 50px">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label"><strong>Contacto:</strong></label>
                                    <div class="col-sm-8">
                    ...
                    <div class="row col-lg-12">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <textarea id="Observación" name="Observación" class="form-control" autocomplete="off" placeholder="Observación"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" name="tipo_operacion">
                                        ...
                                        <option id="11">0201 - Exportación de Servicios - Prestación servicios
                                            realizados</option>
                                        <option id="12">1001 - Operacion Sujeta a Detracción</option>
                                        <option id="13">1002 - Operacion sujeta a detracción - Recursos
                                            Hidrobiológicos</option>
                                        <option id="14">1003 - Operacion sujeta a detracción - Servicios de
                                            transporte pasajeros</option>
                                        <option id="15">1004 - Operacion sujeta a detracción - Servicios de
                                            transporte de carga</option>
                                        <option id="16">2001 - Operación Sujeta a Percepción</option>
                                        <option id="17">2002 - Operación Sujeta a Retención de Renta de segunda
                                            categoría</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="Nombre" name="Nombre" class="form-control"
                                                ...
                                                <option value="">443 | EP-000292 | 2192584 | WIRELESS LAN USB
                                                    MODULE EPSON</option>
                                                <option value="">19 | SERV-00000019 | SERV-00000019 | 729790 WIRE
                                                    22-Aug-24 LP005947</option>
                                                <option value="">18 | SERV-00000018 | SERV-00000018 | 729790 WIRE
                                                    22-Aug-24 LP005979</option>
                                                <option value="">20 | SERV-00000020 | SERV-00000020 | 729790 WIRE
                                                    24-Jun-24 LP005704</option>
                                                <option value="">22 | SERV-00000022 | SERV-00000022 | 729790 WIRE
                                                    23 - Oct - 2023 LP004720</option>
                                                <option value="">21 | SERV-00000021 | SERV-00000021 | 729790 WIRE
                                                    25- Sep -2023 LP004623</option>
                                            </select>
                                        ...
                                        <td>
                                            <input type="number" id="cantidad0" name="cantidad[]" min="1"
                            ...
                            <table cellspacing="0" class="table tables">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input id="subtotal" type="text" disabled class="form-control"
                                                required="">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input id="igv" type="text" disabled class="form-control"
                                                required="">
                                        </td>
                                    </tr>
                                    <tr>
