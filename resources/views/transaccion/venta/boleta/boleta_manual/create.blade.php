        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{route('boleta_manual.store')}}"  enctype="multipart/form-data" method="post" id="form_store">
                        @csrf
                        <div class="row">
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td>Cliente</td>
                                    <td>:</td>
                                    <td><select class="select2_demo_client" name="cliente" id="cliente" required=""></select></td>
                                    <td>Almacen</td>
                                    <td>:</td>
                                    <td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="alert alert-danger alert-dismissible fade show" role="alert"  id="suma_campos" style="display: none" >
                                                                    <strong style="font-size:11px">La suma de las cuotas es diferente al monto total</strong>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td colspan="4">
                                        <textarea class="form-control" name="observacion" id="observacion" >Emitimos la siguiente Boleta a vuestra solicitud</textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <table cellspacing="0" class="table tables">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input style="width: 76px" type='number' step="0.0000001" id='precio0' name='precio[]'  class="monto0 form-control inp" onkeyup="multi_s_igv(0),multi(0)" required  autocomplete="off" />
                                        ...
                                        <td>
                                            <input style="width: 76px" type='number' step="0.0000001" id='precio_c_igv0' name='precio_c_igv[]'  class="precio_c_igv monto0 form-control inp" onkeyup="multi_c_igv(0),multi(0)" required  autocomplete="off" />
                                        </td> 
                                        <td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button type="button" name="name" value="submit" class="ladda-button btn btn-info float-right" id="boton"  style="margin-right: 5px">Enviar</button>
    ...
    $(".addmore").on('click', function () {
        var data = `[
            <tr>
                ...
                <td>
                    <input type='number' style="width: 76px"step="0.0000001"  id='precio${i}' onchange="change(${i})" name='precio[]' class="monto${i} form-control inp" onkeyup="multi_s_igv(${i}),multi(${i})" required  autocomplete="off"/>
                ...
                <td>
                    <input style="width: 76px" type='number' step="0.0000001"id='precio_c_igv${i}' name='precio_c_igv[]'  class="precio_c_igv p_inp monto${i} form-control inp" onkeyup="multi_c_igv(${i}),multi(${i})" required  autocomplete="off" />
                </td>
                <td>
