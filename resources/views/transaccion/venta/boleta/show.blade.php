                ...
                <div class="row tooltip-demo">
                    <div class="col-sm-6">
                        ...
                        @if($boleta->nota_credito != 0)
                            <span data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Motivo: {{ Boleta::search_motivo_nc($boleta->id)}}">
                                <a class="btn btn-primary" href="{{route('nota-credito.show',Boleta::nota_credito_id($boleta->id))}}">Ver nota de Credito</a>
                            </span>
                        @endif
                    </div>
                    <div class="col-sm-6" align="right">
                        ...
                        <a href="{{ route('boleta.ticket', $boleta->id) }}" class="btn btn-info" target="_blank"><i
                        ...
                        <div id="div-mostrar" style="height: 0px; overflow: hidden;">
                            <form action="{{ route('agregado.whatsapp_send') }}" method="post" class="btn"
                                ...
                                <input type="text" hidden="" name="url"
                                    value="{{ route('pdf_bol', $boleta->id) }}?archivo=">
                                <input type="text" name="name_sin_cambio" hidden=""
                                    value="Boleta_{{ $boleta->codigo_boleta }}" />
