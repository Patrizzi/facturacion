...
@section('title', 'Nota Debito Servicio')
@section('breadcrumb', 'Nota Debito Servicio')
@section('breadcrumb2', 'Nota Debito Servicio')
                                    ...
                                    @foreach($notas_debito_registros as $e => $notas_debito_registro)
                                        <tr>
                                            ...
                                            <td style="display: none">
                                                {{-- {{$sub_total=($notas_debito_registro->factura_ids->op_gravada)+($notas_debito_registro->factura_ids->op_inafecta)+($notas_debito_registro->factura_ids->op_exonerada)}}
                                                {{$sub_total_gravado=($notas_debito_registro->factura_ids->op_gravada)}}
