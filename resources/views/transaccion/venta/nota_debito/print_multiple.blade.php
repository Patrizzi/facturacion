...
<body class="white-bg">
    ...
    if ($estado == 0) { $moneda = $nota_debito->nota_i_facturacion->moneda; }
    elseif ($estado == 1) { $moneda = $nota_debito->nota_i_boleta->moneda; }
    elseif ($estado == 3) { $moneda = $nota_debito->nota_i_boleta_manual->moneda; }
    else { $moneda = $nota_debito->nota_i_fac_manual->moneda; }
    @endphp
                    ...
                    <div class="col-sm-4">
                        <div class="form-control ruc" style="height:125px">
                            <center>
                                ...
                                <h2 class="dark-bold">NOTA DE DÉBITO</h2>
                    ...
                    <div class="col-sm-6" align="center">
                        <div class="form-control">
                            <div align="left">
                                ...
                                @endif
                                <span class="dark-bold">Orden de Compra:</span> <span class="dark-regular">{{ $document->orden_compra }}</span><br>
                                <span class="dark-bold">Guía de Remisión:</span> <span class="dark-regular">{{ $document->guia_remision }}</span><br>
                                <span class="dark-bold">Fecha Emisión:</span> <span class="dark-regular">{{ $document->fecha_emision }}</span><br>
                            </div>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="form-control">
                            <div align="left" class="row">
                                <div class="col-sm-6">
                                    ...
                                    <span class="dark-regular">Interés por mora</span>
                                    @elseif($nota_debito->tipo == 02)
                                    <span class="dark-regular">Aumentos en el valor</span>
                                    @else
                                    <span class="dark-regular">Penalidad</span>
                                    @endif
                                </div>
                                <div class="col-sm-6">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="dark-regular">
                                    {{ $nota_debito_registro->servicio->descripcion }}
                                    @if(isset($doc_reg[$e])) {{ $doc_reg[$e]->descripcion_item }} @endif
                                </td>
                                @endif
                    ...
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <br>
                                <small class="dark-regular" style="font-size:70%;">Representación Impresa de <strong class="dark-bold">NOTA DE DÉBITO ELECTRÓNICA</strong></small>
