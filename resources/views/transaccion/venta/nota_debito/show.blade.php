            ...
            <div class="ibox-content" style="padding-right: 3.1%;padding-left: 3.1%; padding-bottom: 10px;">
                <div class="row tooltip-demo">
                    <div style="display: flex; flex-direction: column;">
                        ...
                        <h5 style="margin: 0;">{{ $notas_debito->codigo_n_d }}</h5>
                    </div>
                    ...
                    <div
                        ...
                        <form class="btn" style="padding: 0;" action="{{ route('nota_debito.pdf', $notas_debito->id) }}">
                            <input type="text" name="name" maxlength="50" hidden
                                value="{{ $notas_debito->codigo_n_d }}">
                        ...
                        <a class="btn btn-success" href="{{ route('nota_debito.print', $notas_debito->id) }}"
                        ...
                        <div id="div-mostrar" style="height: 0px; overflow: hidden; width: 100%; transition: height .4s;">
                            <form action="{{ route('agregado.whatsapp_send') }}" method="post" class="btn"
                                ...
                                <input type="tel" name="numero"
                                    value="{{ $notas_debito->cliente_obj->celular ?? '' }}" />
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if (isset($notas_debito_registro->producto_id))
                                        ...
                                        <td>{{ $notas_debito_registro->producto->nombre }}
                                            <br><strong>N/S:</strong>{{ $notas_debito_registro->numero_serie }}</td>
                                    @else
                                        <td>{{ $notas_debito_registro->servicio->codigo_servicio }}</td>
                                        <td>{{ $notas_debito_registro->servicio->nombre }}
                                            <br><strong>N/S:</strong>{{ $notas_debito_registro->numero_serie }}</td>
                                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-control">
                            ...
                            <span style="display: block;float: right">{{ $simbologia }}
                                {{ number_format($notas_debito->op_gravada, 2) }}</span><br>
                            <span style="display: block;float: left"> Op. Inafecta: </span>
                            <span style="display: block;float: right">{{ $simbologia }}
                                {{ number_format($notas_debito->op_inafecta, 2) }}</span><br>
                            <span style="display: block;float: left"> Op. Exonerada: </span>
                            <span style="display: block;float: right">{{ $simbologia }}
                                {{ number_format($notas_debito->op_exonerada, 2) }} </span><br>
