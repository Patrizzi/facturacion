                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-5 col-md-6 col-sm-12">
                                                                    <div class="input-group">
                                                                        <input class="form-control" type="text"
                                                                            name="daterange" id="data_range_filter"
                                                                ...
                                                                <div class="col-lg-5 col-md-6 col-sm-12">
                                                                    <input type="search" class="form-control"
                                                                        placeholder="Buscar:" id="search_all_column">
                                                                </div>
                                                                ...
                                                                <tbody>
                                                                    @foreach ($facturas as $factura)
                                                                        <tr class="gradeX">
                                                                            ...
                                                                            <td>
                                                                                <form method="POST"
                                                                                    action="{{ route('nota-debito.create_nota_debito') }}">
                                                                                    @csrf
                                                                ...
                                                                <tbody>
                                                                    @foreach ($factura_manual as $facturam)
                                                                        <tr class="gradeX">
                                                                            ...
                                                                            <td>{{ \Carbon\Carbon::parse($facturam->fecha_emision)->format('d/m/Y') }}</td>
                                                                            <td>{{ $facturam->cliente->nombre }}</td>
                                                                            <span
                                                                                hidden>{{ $subtotal = $facturam->op_gravada + $facturam->op_inafecta + $facturam->op_exonerada }}
                                                                            </span>
                                                                            <td>{{ $facturam->moneda->simbolo }}
                                                                                {{ number_format(round($subtotal + ($facturam->op_gravada * $igv->renta) / 100, 2), 2) }}
                                                                            </td>
                                                                            <td>
                                                                                <form method="POST"
                                                                                    action="{{ route('nota-debito.create_nota_debito') }}">
