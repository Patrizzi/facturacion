        ...
        <div class="row">
            <div class="col-lg-12" style="margin-top: -5px;">
                <div class="ibox-content p-xl" style=" margin-bottom: 20px;padding-bottom: 50px;">
                    ...
                    <form action="{{ route('nota-debito.nota_debito_bol', $boleta->id) }}" enctype="multipart/form-data"
                        method="post">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="motivo" id="mot" class="form-control"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if (isset($boleta_registros->producto_id))
                                            ...
                                            <td>{{ $boleta_registros->producto->nombre }} <br><strong>N/S:</strong>
                                                {{ $boleta_registros->numero_serie }}</td>
                                        @else
                                            <td>{{ $boleta_registros->servicio->codigo_producto }}</td>
                                            <td>{{ $boleta_registros->servicio->nombre }} <br><strong>N/S:</strong>
                                                {{ $boleta_registros->numero_serie }}</td>
                                        @endif
                                        <td>{{ $boleta_registros->cantidad }}</td>
                                        <td>{{ $boleta_registros->precio }}</td>
                                        <td><input required="required" class="form-control" type="ni,number"
                                                id="input_disabled_precio_{{ $e }}"
                                                name="input_disabled_precio_{{ $e }}" value="0"
                                                step="0.01" min="0.01" disabled></td>
                                   ...
                                   <span hidden="hidden">{{$i++}}</span> --}}
                                    ...
                                    <tr>
                                        <td colspan="13" align="right"><button type="button"
                                                class="btn btn-w-m btn-primary">Enviar</button>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($boleta_registro as $e => $boleta_registros)
                                                        <tr>
                                                            <td><input class="form-check-input i-checks" type="checkbox"
                                                                    id="inlineCheckbox_{{ $e }}"
                                                                    name="inlineCheckbox_{{ $e }}"
                                                                    onclick="check('{{ $e }}')"></td>
                                                            <td>{{ $u++ }}</td>
