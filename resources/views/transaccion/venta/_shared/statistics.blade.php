                ...
                @can('cotizacion_m.listar')
                    <div class="carousel-item {{ !$activeSet ? 'active' : '' }}">
                        <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                            ...
                            <p style="margin: 5px 0;">{{ $count_month_ventas['cotizacion_m_month_count']['cantidad'] }}
                                Documentos</p>
                ...
                @can('coti_renovacion.listar')
                    <div class="carousel-item {{ !$activeSet ? 'active' : '' }}">
                        <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                            ...
                            <p style="margin: 5px 0;">{{ $count_month_ventas['renovacion_month_count']['cantidad'] ?? 0 }}
                                Documentos</p>
...
@can('clientes.listar')
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
            ...
            <p style="margin: 5px 0;">{{ $count_month_ventas['clientes_month_count'] }} @if ($count_month_ventas['clientes_month_count'] == 1)
                    Cliente
                @else
                    Clientes
                @endif
