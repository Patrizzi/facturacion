                    ...
                    <form action="{{ route('nota_venta.store') }}" enctype="multipart/form-data" method="post"
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label
                                        class="col-lg-3 col-md-5 col-xl-2 col-form-label"><strong>Cliente:</strong></label>
                                ...
                                <div class="form-group row">
                                    <label
                                        class="col-lg-3 col-md-5 col-xl-2 col-form-label"><strong>F.Pago:</strong></label>
                                    <div class="col-lg-9 col-md-7 col-xl-10">
                                        <select class="form-control m-b" name="forma_pago" required="required">
                                            @foreach ($forma_pagos as $forma_pago)
                                ...
                                <div class="form-group  row">
                                    <label
                                        class="col-lg-3 col-md-5 col-xl-2 col-form-label"><strong>Almacen:</strong></label>
                                    <div class="col-lg-9 col-md-7 col-xl-10">
                                        <input type="text" class="form-control" value="{{ $almacen->nombre }}"
                                            disabled>
                                        <input type="text" class="form-control" value="{{ $almacen->id }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label
                                        class="col-lg-3 col-md-5 col-xl-2 col-form-label"><strong>F.Emisión:</strong></label>
                                    <div class="col-lg-9 col-md-7 col-xl-10">
                                        <input type="text" name="fecha_emision" class="form-control m-b"
                                            value="{{ date('d-m-Y') }}" readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group  row">
                                    <label
                                        class="col-lg-3 col-md-5 col-xl-2 col-form-label"><strong>Garantía:</strong></label>
                                    <div class="col-lg-9 col-md-7 col-xl-10">
                                        <select class="form-control m-b" name="garantia">
                                            @foreach ($garantia as $garantias)
                                ...
                                <div class="form-group  row">
                                    <label
                                        class="col-lg-3 col-md-5 col-xl-2 col-form-label"><strong>Moneda:</strong></label>
                                    <div class="col-lg-9 col-md-7 col-xl-10">
                                        <select name="moneda" class="form-control m-b" required id="moneda_id">
                                            @foreach ($moneda as $monedas)
                                                <option value="{{ $monedas->id }}">{{ $monedas->nombre }}</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label
                                        class="col-xl-1 col-md-3 col-lg-2 col-form-label"><strong>Observación:</strong></label>
