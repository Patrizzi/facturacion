...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            /* limpiar línea/borde superior y sombras del layout */
            .wrapper,
            .white-bg,
            .ibox,
            .ibox-content,
...
<body class="white-bg">
    ...
    if ($estado == 0) { $moneda = $nota_credito->nota_i_facturacion->moneda; }
    elseif ($estado == 1) { $moneda = $nota_credito->nota_i_boleta->moneda; }
    elseif ($estado == 3) { $moneda = $nota_credito->nota_i_boleta_manual->moneda; }
    else { $moneda = $nota_credito->nota_i_fac_manual->moneda; }
    @endphp
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="form-control" style="height:125px">
                            <div class="row">
                                <div class="col-sm-3">
                                    <center><img src="{{ asset('img/logo/' . $empresa->logo) }}" width="80" height="80"></center>
                                </div>
                                <div class="col-sm-9">
                                    <center>
                                        <h3 class="dark-bold" style="margin-bottom:0;">{{ $empresa->nombre_comercial }}</h3>
                                        <p class="dark-regular" style="margin-bottom:0; font-size:12px;">
                    ...
                    <div class="col-sm-4">
                        <div class="form-control ruc" style="height:125px">
                            <center>
                                <h3 class="dark-bold" style="padding-top:10px">R.U.C : {{ $empresa->ruc }}</h3>
                    ...
                    <div class="col-sm-6" align="center">
                        <div class="form-control">
                            <div align="left">
                                ...
                                @endif
                                <span class="dark-bold">Orden de Compra:</span> <span class="dark-regular">{{ $document->orden_compra ?? 'N/A' }}</span><br>
                                <span class="dark-bold">Guia de Remision:</span> <span class="dark-regular">{{ $document->guia_remision ?? 'N/A' }}</span><br>
                                <span class="dark-bold">Fecha Emision:</span>
                                <span class="dark-regular">
                                    @if(isset($nota_credito->fecha_emision)) {{ $nota_credito->fecha_emision }} @else {{ $nota_credito->created_at }} @endif
                                </span><br>
                            </div>
                        </div>
                    </div>
                            ...
                            <div align="left" class="row">
                                <div class="col-sm-6">
                                    ...
                                    <span class="dark-regular">
                                        ...
                                        @case(01) Anulación de la operación @break
                                        @case(02) Anulación por error en el RUC @break
                                        @case(03) Corrección por error en la descripción @break
                                        @case(06) Devolución total @break
                                        @default {{ $nota_credito->motivo }}
                                        @endswitch
                                    </span>
                                </div>
                                <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <br>
                                <small class="dark-regular" style="font-size:70%;">Representación Impresa de <strong class="dark-bold">NOTA DE CRÉDITO ELECTRÓNICA</strong></small>
                                <small class="dark-regular" style="font-size:70%;">Esta puede ser consultada en www.codecta.pe</small>
                                <small class="dark-regular" style="font-size:70%;">Autorizado mediante Resolución de Intendencia N° 0180050001374/SUNAT</small>
                            </div>
                            <div class="col-sm-4 qr-container">
                                <div class="qr-box">
                                    @if(!empty($notaData['qrCode']))
                                        <img src="{{ $notaData['qrCode'] }}" alt="Código QR" class="qr-image">
                                    @else
