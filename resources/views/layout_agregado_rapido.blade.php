                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-3 ">
                                                   <label>Código Ubigeo * <a href="https://account.geodir.co/recursos/ubigeo-inei-peru.html" target="_blank"><i class="fa fa-question-circle" style="cursor: pointer;font-size: 15px;transition: 1s;z-index:9999" ></i></a></label>
