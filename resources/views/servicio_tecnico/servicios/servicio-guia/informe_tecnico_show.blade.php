        ...
        <div class="ibox-content">
            <div class="row align-items-center tooltip-demo">
                <div class="col-12 col-md-3">
                    ...
                    <strong style="margin: 0;">{{$informeTecnico->servicioGuia->cliente->documento_identificacion ??
                        'DNI'}} :</strong>{{$informeTecnico->servicioGuia->cliente->numero_documento}}
                </div>
                ...
                <div class="col-12 col-md-5 d-flex flex-wrap justify-content-end align-items-center" style="gap: 4px;">
                    <a href="" class="btn btn-secondary" target="_blank" data-toggle="tooltip" data-placement="bottom"
                    ...
                    <a class="btn btn-success" href="" target="_blank" data-toggle="tooltip" data-placement="bottom"
                    ...
                    <div class="col-sm-6" align="center">
                        <div class="form-control" style="height: 90%">
                            ...
                            <div align="left">
                                ...
                                <strong>Teléfono:</strong>&nbsp;{{$informeTecnico->servicioGuia->cliente->telefono ??
                                '00000'}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <strong>Correo:</strong>&nbsp; {{$informeTecnico->servicioGuia->cliente->email ?? 'No
                                especificado'}}<br>
                                <strong>Dirección:</strong>&nbsp; {{$informeTecnico->servicioGuia->cliente->direccion ??
                                'No especificada'}}<br>
                                <strong>Celular:</strong>&nbsp; {{$informeTecnico->servicioGuia->cliente->celular ??
                                '0000000'}}<br>
                            </div>
                            @else
                            <div align="left">
                    ...
                    <div class="col-sm-6" align="center">
                        <div class="form-control" style="height: 90%">
                            ...
                            <div align="left">
                                ...
                                <strong>Fecha Registro:</strong>&nbsp;{{date("d/m/Y",
                                strtotime($informeTecnico->servicioGuia->fecha_creacion))}}<br>
                            </div>
                            @else
                            <div align="left">
