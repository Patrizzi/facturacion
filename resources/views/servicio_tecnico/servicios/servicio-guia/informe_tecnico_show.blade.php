...
<div class="row" style="padding-bottom: 20px">
    ...
    <div class="col-sm-6">
        <div class="form-control" style="height: auto; min-height: 180px;">
            <h4
                style="text-align: center; padding: 10px 0; margin-bottom: 15px; color: #666; font-weight: bold; background-color: #f8f9fa; margin: -1px -1px 15px -1px; border-bottom: 1px solid #ddd;">
                Contacto Cliente
            </h4>
            ...
            @if($informeTecnico)
                <div style="text-align: left; padding: 0 15px;">
                    ...
                    <div style="margin-bottom: 12px;">
                        ...
                        {{ $informeTecnico->servicioGuia->cliente->direccion ?? 'No especificada' }}
                    </div>
                    <div class="row">
...
<div class="row" style="padding-bottom: 20px">
    <div class="col-sm-12" align="center">
        <div class="form-control" style="height: auto;">
            <h3 style="padding-top:10px; margin-bottom: 20px; color: #333; font-weight: bold;">INFORMACIÓN DEL SERVICIO
                TÉCNICO</h3>
                    ...
                    <div style="margin-bottom: 10px;">
                                                ...
                                                <div class="form-control" style="height: 90%">
                                                    ...
                                                    @if($informeTecnico)
                                                        <div align="left">
                                                            ...
                                                            {{$informeTecnico->servicioGuia->cliente->email ?? 'No especificado'}}<br>
                                                            <strong>Dirección:</strong>&nbsp;
                        ...
                        @else
                                                                            <div class="alert alert-info" style="margin-top: 15px;">
                                                                                <i class="fa fa-info-circle"></i> No se encontró información del informe
                                                                                técnico.
                                                                            </div>
                                                                            @endif
                                                                        </div>
                                                                                        ...
                                                                                        @foreach($ingreso->servicioGuiaEgreso as $egreso)
                                                                                            <tr>
                                                                                                ...
                                                                                                <td style="padding: 10px; text-align: center;">
                                                                                                    {{ $egreso->fecha_inicio_reparacion ?? '—' }}</td>
                                                                                                <td style="padding: 10px; text-align: center;">
                                                                                                    {{ $egreso->fecha_fin_reparacion ?? '—' }}</td>
                                                                            ...
                                                                            @else
                                                                                <tr>
                                                                                    <td colspan="7" style="text-align: center; padding: 20px; color: #666;">
                                                                                        <i class="fa fa-info-circle"></i> No hay equipos registrados para este
                                                                                        informe técnico.
                                                                                    </td>
                                                                                </tr>
                                                                            @endif
