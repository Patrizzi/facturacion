    ...
    <div class="modal-dialog modal-dialog-centered modal-xl-manual">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" enctype="" id="form_Umedida">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-9 row">
                            <div class="col-sm-6">
                                <!--
                                <select class="form-control m-b" name="nombre_medida" id="nombre_medida">
                                    <option>Bolsa</option>
                                    <option>Kilogramos</option>
                                    <option>Litros</option>
                                    <option>option 4</option>
                                </select>-->
                                <input type="text" placeholder="Nombre U.Medida: " class="form-control m-b" name="nombre_medida" id="nombre_medida">
                            </div>
                            <div class="col-sm-6">
                                <input type="text" placeholder="Símbolo: BOL" class="form-control m-b" name="simbolo_medida" id="simbolo_medida" required  autocomplete="off">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <input type="text" disabled="" placeholder="Fecha Actualización: 12-03-1997" name="fecha_medida" id="fecha_medida" class="form-control" autocomplete="off">
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="table-responsive">
                        <!--Tabla-->
                        <table class="table table-striped text-md-center table-bordered dataTables-medida">
                            <thead>
                                <tr>
