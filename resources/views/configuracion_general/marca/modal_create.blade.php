            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12 row">
                        ...
                        <div class="col-10">
                            <input type="text" placeholder="Descripción: Empresa especializada en la creación de..."
                ...
                <div class="row px-2 py-3 bg-light m-1 table-responsive">
                    <!--Tabla-->
                    <table class="table table-striped dataTables-marcas">
                        <thead>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (isset($marca->imagen))
                                            <img name="imagen"
                                                src="{{ asset('archivos/imagenes/marcas/' . $marca->imagen) }}"
