        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                    ...
                    {{-- <p style="margin: 5px 0;">{{ $count_month_comprobantes['boleta_month_count']['cantidad'] }}
                        Documentos</p> --}}
                    <p style="color: green; font-weight: bold;">
                        {{-- {{ $count_month_com.probantes['boleta_month_count']['total'] }}</p> --}}
                </div>
            </div>
            <div class="carousel-item">
                <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                    ...
                    {{-- <p style="margin: 5px 0;">{{ $count_month_comprobantes['boleta_m_month_count']['cantidad'] }}
                        Documentos</p> --}}
                    {{-- <p style="color: green; font-weight: bold;">
                        {{ $count_month_comprobantes['boleta_m_month_count']['total'] }}</p> --}}
                </div>
            </div>
        </div>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                    ...
                    {{-- <p style="margin: 5px 0;">{{ $count_month_comprobantes['factura_month_count']['cantidad'] }}
                        Documentos</p> --}}
                    {{-- <p style="color: orange; font-weight: bold;">
                        {{ $count_month_comprobantes['factura_month_count']['total'] }}</p> --}}
                </div>
            </div>
            <div class="carousel-item">
                <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                    ...
                    {{-- <p style="margin: 5px 0;">{{ $count_month_comprobantes['factura_m_month_count']['cantidad'] }}
                        Documentos</p> --}}
                    {{-- <p style="color: orange; font-weight: bold;">
                        {{ $count_month_comprobantes['factura_m_month_count']['total'] }}</p> --}}
                </div>
            </div>
        </div>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                    ...
                    {{-- <p style="margin: 5px 0;">{{ $count_month_comprobantes['nota_credito_month_count']['cantidad'] }}
                        Documentos</p> --}}
                    <p>&nbsp;</p>
            ...
            <div class="carousel-item">
                <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                    ...
                    {{-- <p style="margin: 5px 0;">{{ $count_month_comprobantes['nota_debito_month_count']['cantidad'] }}
                        Documentos</p> --}}
                    <p>&nbsp;</p>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                    ...
                    {{-- <p style="margin: 5px 0;">{{ $count_month_comprobantes['guia_remision_month_count']['cantidad'] }}
                        Documentos</p> --}}
            ...
            <div class="carousel-item">
                <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                    ...
                    <p style="margin: 5px 0;">
                        {{-- {{ $count_month_comprobantes['guia_remisionM_month_count']['cantidad'] }} Documentos</p> --}}
