                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#exampleModal{{ $personal->id }}">Editar</button>
                                                <div class="modal fade" id="exampleModal{{ $personal->id }}" tabindex="-1"
                                                        ...
                                                        <div class="modal-content">
                                                            <div style="padding-left: 15px;padding-right: 15px;">
                                                                ...
                                                                <div class="ibox-content"
                                                                    ...
                                                                    <form
                                                                        action="{{ route('usuario.creacion', $personal->id) }}"
                                                                        ...
                                                                        <fieldset>
                                                                            <legend style="height: 250px;">
                                                                                ...
                                                                                <div id="visorArchivo">
                                                                                    <img src="{{ asset('/profile/images/') }}/{{ $personal->foto }}"
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-10"
                                                                                            ...
                                                                                            <input type="password"
                                                                                                ...
                                                                                                required="required"></div>
                                                                                        <label
                                                                                            class="col-sm-2 col-form-label">Almacen
                                                                                            Asignado:</label>
                                                                                        <div class="col-sm-10">
                ...
                if (archivoInput.files && archivoInput.files[0]) {
                    ...
                    visor.onload = function(e) {
                        document.getElementById('visorArchivo').innerHTML =
                            '<center><img name="avatar" src="' + e.target.result +
