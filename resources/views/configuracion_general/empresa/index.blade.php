                        ...
                        <div class="d-flex flex-column flex-md-row align-items-center"
                            ...
                            <div class="mb-3 mb-md-0" style="flex: 0 0 auto; margin-right: 0px;">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCrz_XKzKwCeiR3Te3FDc-zTIDtxgLMVE5CA&s"
                                    alt="Imagen de la empresa" style="max-width: 100%; height: auto; width: 100px;">
                            </div>
                            <div class="text-center" style="flex: 1;">
                                <h5>J&P Perifericos S.A.C</h5>
                                <p>RUC: 20545122520</p>
                                <p>Empresa de mantenimiento informático, venta de computadoras, hardware, software ERP,
                                    elaboración de páginas web, redes y comunicaciones, utilizando la tecnología actual para
                                    servirlos mejor.</p>
                            </div>
                            <div style="flex: 0 0 auto;">
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#infoModal">Editar</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4"> <!-- Tarjeta de "Mi empresa" -->
                    <div class="card text-center"
                        ...
                        <div style="display: flex; justify-content: center;">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCrz_XKzKwCeiR3Te3FDc-zTIDtxgLMVE5CA&s"
                                class="card-img-top" alt="..." style="width: 355px; height: auto;">
                        </div>
                        <div class="card-body">
                            <h5 class="card-title" style="color: blue; font-weight: bold; font-size: 2rem;">MI EMPRESA
                            </h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-center"
                        ...
                        <div class="card-body"
                            ...
                            <h5 class="card-title"
                                ...
                                CONTACTOS</h5>
                            <p class="card-text" style="margin: 5px 0; text-align: center;"><i
                                    class="bi bi-telephone"></i> Teléfono: 013308292</p>
                            <p class="card-text" style="margin: 5px 0; text-align: center;"><i class="bi bi-phone"></i>
                                Celular: +51946201443</p>
                            <p class="card-text" style="margin: 5px 0; text-align: center;"><i class="bi bi-globe"></i>
                                Sitio Web: www.jypsac.com/<a href="..."
                ...
                <div class="col mb-4"> <!-- Agregado mb-4 -->
                    <div class="card text-center"
                        ...
                        <div class="card-body d-flex flex-column justify-content-center"
                            style="min-height: 260px; align-items: center;">
                            <h5 class="card-title" style="text-align: center;font-weight: bold; font-size: 1rem"> DATOS DE
                                UBICACIÓN</h5>
                            <p class="card-text" style="margin: 5px 0; text-align: center;"><i class="bi bi-flag"></i>
                                País: Perú</p>
                            <p class="card-text" style="margin: 5px 0; text-align: center;"><i class="bi bi-geo"></i>
                                Provincia: Lima</p>
                            <p class="card-text" style="margin: 5px 0; text-align: center;"><i class="bi bi-geo"></i>
                                Ciudad: Lima</p>
                            <p class="card-text" style="margin: 5px 0; text-align: center;"><i class="bi bi-geo-alt"></i>
                                Dirección: Av. Bolivia 148 Of. 2218 Pta 4 - Galería Centro de Lima</p>
                            <p class="card-text" style="margin: 5px 0 20px 0; text-align: center;"><i
                                    class="bi bi-file-earmark-binary"></i> Código Ubigeo: 150101</p>
                            <!-- Mapa incrustado -->
                            <iframe
                ...
                <div class="col mb-4">
                    <div class="row">
                        <div class="col mb-4"> <!-- Columna para la tarjeta -->
                            <div class="card text-center"
                                style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0); height: 200px;box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2);">
                                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <div class="d-flex flex-column align-items-start mb-3">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <p class="card-text mb-0" style="color: gold; font-weight: bold;">Soles /
                                                Moneda Nacional</p>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            <button type="button"
                                                class="rounded-circle bg-success d-flex justify-content-center align-items-center"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary"
                                                            id="cambiarButton">Sí, Cambiar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col mb-8"> <!-- Tarjeta Datos de Ubicación -->
                                        <div class="card text-center" style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0); box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2); min-height: 240px;">
                                            ...
                                            <div class="modal fade" id="cuentaModal" tabindex="-1"
                                                aria-labelledby="cuentaModalLabel" aria-hidden="true">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="codigoInterbancario"
                                                                            ...
                                                                            Interbancario</label>
                                                                        <input type="text" class="form-control"
                                                                            id="codigoInterbancario"
                                                                            value="00219113089518605654">
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="modal fade" id="scotiabankModal" tabindex="-1"
                                                aria-labelledby="scotiabankModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="nombreCuenta"
                                                                            class="form-label">Nombre</label>
                                                                        <input type="text" class="form-control"
                                                                            id="nombreCuenta" value="Cuenta Corriente">
                                                                        <!-- Titular colocado directamente aquí -->
                                                                        <label for="titularCuenta"
                                                                            class="form-label">Titular</label>
                                                                        <input type="text" class="form-control"
                                                                            id="titularCuenta" value="0873003385919">
                                                                    </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <label for="imagenCuenta"
                                                                            class="form-label"></label>
                                                                        <img src="IMG/scotiabank.png" alt="BCP"
                                                                            class="img-fluid" style="max-width: 150px;">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form>
                                                                <div class="row mb-3">
                                                                    <!-- Nombre -->
                                                                    <div class="col-md-6">
                                                                        <label for="nombreCuentaInterbank"
                                                                            class="form-label">Nombre</label>
                                                                        <input type="text" class="form-control"
                                                                            id="nombreCuentaInterbank"
                                                                            value="Cuenta Corriente">
                                                                        <!-- Titular colocado directamente aquí -->
                                                                        <label for="titularCuentaInterbank"
                                                                            class="form-label">Titular</label>
                                                                        <input type="text" class="form-control"
                                                                            id="titularCuentaInterbank"
                                                                            value="001101750100068128 76">
                                                                    </div>

                                                                    <!-- Imagen de la cuenta -->
                                                                    <div
                                                                        class="col-md-6 d-flex flex-column align-items-center justify-content-center">
                                                                        <label for="imagenCuentaInterbank"
                                                                            class="form-label"></label>
                                                                        <img src="IMG/interbank.jpeg" alt="Interbank"
                                                                            class="img-fluid" style="max-width: 150px;">
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select class="form-control" id="numeroCuentaBBVA">
                                                                            ...
                                                                            <option value="01117500010006812876">
                                                                                01117500010006812876</option>
                                                                            <option value="001101470200665686">
                                                                                001101470200665686</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="codigoInterbancarioInterbank"
                                                                            class="form-label">Cod. C.
                                                                            Interbancario</label>
                                                                        <input type="text" class="form-control"
                                                                            id="codigoInterbancarioInterbank"
                                                                            value="01114700020066568668">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form>
                                                                <div class="row mb-3">
                                                                    <!-- Nombre -->
                                                                    <div class="col-md-6">
                                                                        <label for="nombreCuentaBBVA"
                                                                            class="form-label">Nombre</label>
                                                                        <input type="text" class="form-control"
                                                                            id="nombreCuentaBBVA" value="Cuenta Ahorros">
                                                                        <!-- Titular colocado directamente aquí -->
                                                                        <label for="titularCuentaBBVA"
                                                                            class="form-label">Titular</label>
                                                                        <input type="text" class="form-control"
                                                                            id="titularCuentaBBVA" value="19130895186056">
                                                                    </div>

                                                                    <!-- Imagen de la cuenta -->
                                                                    <div
                                                                        class="col-md-6 d-flex flex-column align-items-center justify-content-center">
                                                                        <label for="imagenCuentaBBVA"
                                                                            class="form-label"></label>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="codigoInterbancarioBBVA"
                                                                            class="form-label">Cod. C.
                                                                            Interbancario</label>
                                                                        <input type="text" class="form-control"
                                                                            id="codigoInterbancarioBBVA"
                                                                            value="00219113089518605654">
                                                                    </div>
                                                                </div>
                ...
                if (archivoInput.files && archivoInput.files[0]) {
                    ...
                    visor.onload = function(e) {
                        document.getElementById('visorArchivos').innerHTML =
                            '<img name="fotos" src="' + e.target.result +
                            '" style="width: 350px;margin-bottom: 15px;border-radius: 10px"/>';
                    };
                    visor.readAsDataURL(archivoInput.files[0]);
                }
            }
