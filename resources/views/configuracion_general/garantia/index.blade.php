 ...
 @section('title', 'Tiempo de Garantia')
        ...
        <div class="modal-content">
            <div style="padding-left: 15px;padding-right: 15px;">
                ...
                <div class="ibox-content" style="padding-left: 0px;padding-right: 0px;" align="center">
                    ...
                    <form action="{{ route('garantia.store') }}"  enctype="multipart/form-data" method="post" onsubmit="return valida(this)">
                        @csrf
                        <div>
                            <div class="panel-body" >
                                <div class="row">
                                    <div class="col-sm-12" style="padding-bottom: 15px"><img src="{{asset('img/logos/garantia.png')}}" width="100px"></div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    <td>@if($garantias->estado==0) <i class="fa fa-circle" style="color: green;"></i>@else
                                    <i class="fa fa-circle"></i>@endif {{$i++}}</td>
                                    {{-- <td>{{$garantias->id}}</td> --}}
                                    <td>{{$garantias->descripcion}}</td>
                                    <td align="center">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal{{$garantias->id}}"><i class="fa fa-edit"></i></button>
                                        <div class="modal fade" id="exampleModal{{$garantias->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div style="padding-left: 15px;padding-right: 15px;">
                                                        {{-- ccccccccccccccccc --}}
                                                        <div class="ibox-content" style="padding-left: 0px;padding-right: 0px;" align="center">
                                                            ...
                                                            <form action="{{ route('garantia.update',$garantias->id) }}"  enctype="multipart/form-data" method="post">
                                                                @csrf
                                                                @method('PATCH')
                                                                <fieldset >
                                                                    <div>
                                                                        <div class="panel-body" >
                                                                            ...
                                                                            <div class="row">
                                                                             ...
                                                                             <label class="col-sm-2 col-form-label">Descripcion:</label>
                                                                             <div class="col-sm-10">
                                                                                <input type="text" required class="form-control" name="descripcion" value="{{$garantias->descripcion}}">
                                                                            </div>
                                                                            @if($conteo > 1 || $garantias->estado==1 )
                                                                            <div class="col-sm-12" align="center" style="padding-top: 10px">
                                                                                <input type="checkbox" class="js-switch_{{$garantias->id}}" name="estado"  @if($garantias->estado==0) checked="" @endif />
                                                                           </div>
                                                                           @endif
                    ...
                    <div class="ibox-content">
                        <div class="tabs-container">
                            <ul class="nav nav-tabs" role="tablist">
                                <li>
                                    <a class="nav-link" data-toggle="tab" href="#tab-1"><span style="color: white; background-color: red;" class="px-1">4</span> Activos

                                    </a>
                                </li>
                                <li>
                                    <a class="nav-link active show" data-toggle="tab" href="#tab-2"><span style="color: white; background-color: orange;" class="px-1">4</span> Caducados
...
@foreach($garantia as $garantias)
<script>
    var elem_2 = document.querySelector('.js-switch_{{$garantias->id}}');
    var switchery_2 = new Switchery(elem_2, { color: '#ED5565' });
</script>
@endforeach
@foreach($garantia as $garantias)
<script>
    var elem_2 = document.querySelector('.js-switch_vehiculo{{$garantias->id}}');
    var switchery_2 = new Switchery(elem_2, { color: '#ED5565' });
</script>
@endforeach
@endsection
