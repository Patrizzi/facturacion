            ...
            <div>
                <div class="alert alert-danger">
                    <div class="alert-link" href="#">
                        <li style="color: red;">{{ $error }} <span style="color:black">Precio Recomendado :
                                {{ $paralelo_recomendado }}</span></li>
                    </div>
                </div>
            </div>
        @endif
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <form action="{{ route('tipo_cambio.store') }}" enctype="multipart/form-data" method="post">
                            ...
                            <button type="button" class="btn" id='myajax'
                                style="color: #0073c1;font-weight:bold"><img src="{{ asset('logo_sunat.png') }}"
                                    width="20px">SUNAT</button>
                        </form>
                    </div>
                </div>
            </div>
