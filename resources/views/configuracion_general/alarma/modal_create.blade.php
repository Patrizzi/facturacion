    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="staticBackdropLabel20">Alarma</h3>
            ...
            <div class="modal-body">
                <form action="" method="post" enctype="multipart/form-data" id="form_categoria">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <input type="text" placeholder="Tipo" class="form-control m-b" name="codigo_categoria"
                                id="codigo_categoria_edit" autocomplete="off">
                        </div>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Alarma" class="form-control m-b" name="codigo_categoria"
                                id="codigo_categoria_edit" autocomplete="off">
                        </div>
                        <div class="col-sm-4">
