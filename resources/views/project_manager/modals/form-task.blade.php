        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group d-flex align-items-center">
                    ...
                    {{ html()->select(
                            'user_id',
                            $modalData['users']->mapWithKeys(function ($user) {
                                return [$user->id => $user->personal->nombres.' '.$user->personal->apellidos];
                            }),
                        )->class('form-control')->value(old('user_id', $model->user_id ?? '')) }}
