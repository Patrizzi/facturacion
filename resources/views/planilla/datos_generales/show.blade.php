    ...
    <div>
        <div class="jumbotron fondo_perfil">
            ...
            <div class="row justify-content-md-center" id="superior_vista_dg">
                <div class="col-lg-3"><img src="{{ asset('/profile/images/') }}/{{ $personales->foto }}"
                        class="rounded-circle circle-border m-b-md" style="width: 150px;height: 150px;"></div>
                <div class="col-lg-7" style="padding-top:10px">
                    <div class="row justify-content-md-center" align="center" id="">
                        <div class="col-lg-6" style="padding-top:10px">
                            <div class="form-control show"> {{ $personales->nombres }}</div>
                        </div>
                        <div class="col-lg-6" style="padding-top:10px">
                            <div class="form-control show"> {{ $personales->apellidos }}</div>
                        </div>
                        <div class="col col-lg-6" style="padding-top:10px">
                            <div class="form-control show"> {{ $personales->nacionalidad }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3">
                    <div id="visorArchivo">
                        <img name="foto" class="rounded-circle circle-border m-b-md"
                            src="{{ asset('/profile/images') }}/{{ $personales->foto }}"
                            style="width: 150px;height: 150px;">
                    </div>
                </div>
                <div class="col-lg-7" style="padding-top:10px">
                    <div class="row justify-content-md-center" align="center">
                        <div class="col-lg-6" style="padding-top:10px"> <input class="form-control show" type="text"
                                id="nombre1" value="{{ $personales->nombres }}" onkeyup="PasarValor();"></div>
                        <div class="col-lg-6" style="padding-top:10px"> <input class="form-control show" type="text"
                                id="apellido1" value="{{ $personales->apellidos }}" onkeyup="PasarValor();"></div>
                        <div class="col col-lg-6" style="padding-top:10px"><input type="text" list="paises"
                                id="nacionalidad1" class="form-control show" value="{{ $personales->nacionalidad }}"
                                id="nacionalidad1" onkeyup="PasarValor();">
                            <datalist id="paises">
        ...
        <div class="fh-column">
            ...
            <div align="left">
                <div class="row">
                    ...
                    <div class="col-lg-6" align="right">
                        @can('personal.editar')
                            <div class="client-avatar" onclick="editar_datos_generales()" id="boton_datos_generales"
                                style="cursor: pointer;"><img src="{{ asset('/archivos/imagenes/personal/editar.svg') }}">
                            </div>
                        @endcan
                    </div>
                </div>
            ...
            <div class="row" id="datos_generales_vista" style="margin-bottom: 50px;">
                <div class="col-lg-4">
                    <h4>Documento </h4>{{ $personales->documento_identificacion }}
                    <hr>
                </div>
                <div class="col-lg-4">
                    <h4>Número Documento</h4>{{ $personales->numero_documento }}
                    <hr>
                </div>
                <div class="col-lg-4">
                    <h4>Fecha Nacimiento</h4>{{ $personales->fecha_nacimiento }}
                    <hr>
                </div>
                <div class="col-lg-4">
                    <h4>Género</h4>{{ $personales->genero }}
                    <hr>
                </div>

                <div class="col-lg-4">
                    <h4>Celular</h4>{{ $personales->celular }}
                    <hr>
                </div>
                <div class="col-lg-4">
                    <h4>Teléfono</h4>{{ $personales->telefono }}
                    <hr>
                </div>
                <div class="col-lg-4">
                    <h4>Correo</h4>{{ $personales->email }}
                    <hr>
                </div>
                <div class="col-lg-4">
                    <h4>Dirección</h4>{{ $personales->direccion }}
                    <hr>
                </div>

                <div class="col-lg-4">
                    <h4>Nivel Educativo</h4>{{ $personales->nivel_educativo }}
                    <hr>
                </div>
                <div class="col-lg-4">
                    <h4>Carrera Profesional</h4>{{ $personales->profesion }}
                    <hr>
                </div>
                <div class="col-lg-4">
                    <h4>Estado Civil</h4>{{ $personales->estado_civil }}
                    <hr>
                </div>
                <div class="col-lg-4">
                    <h4>Licencia de Conducir</h4>
                    @if (isset($personales->licencia))
                        {{ $personales->licencia }}
                    @else
                        <span style="font-style: italic"> Sin Licencia</span>
                    @endif
                    <hr>
                </div>
            </div>
            ...
            <form action="{{ route('personal.update', $personales->id) }}" enctype="multipart/form-data" method="post">
                ...
                <div class="row" id="form_datos_generales" hidden="">
                    <input type="text" name="nombres" class="form-control" id="nombre2"
                        value="{{ $personales->nombres }}" hidden="">{{-- recibido de scrips arriba --}}
                    <input type="text" name="apellidos" class="form-control" id="apellido2"
                        value="{{ $personales->apellidos }}" hidden="">{{-- recibido de scrips arriba --}}
                    <input type="text" name="nacionalidad" class="form-control" id="nacionalidad2"
                        value="{{ $personales->nacionalidad }}" hidden="">{{-- recibido de scrips arriba --}}
                    <div class="col-lg-4">
                        <h4>Documento </h4>
                        <select class="form-control m-b" name="documento_identificacion">
                            <option value="{{ $personales->documento_identificacion }}">
                                {{ $personales->documento_identificacion }}</option>
                    ...
                    <div class="col-lg-4">
                        <h4>Número Documento</h4><input type="text" name="numero_documento" class="form-control"
                            value=" {{ $personales->numero_documento }}">
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Fecha Nacimiento</h4><input type="date" name="fecha_nacimiento" class="form-control"
                            value="{{ $personales->fecha_nacimiento }}">
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Género</h4>
                    ...
                    <div class="col-lg-4">
                        <h4>Celular</h4> <input type="text" name="celular" class="form-control"
                            value=" {{ $personales->celular }}">
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Teléfono</h4> <input type="text" name="telefono" class="form-control"
                            value=" {{ $personales->telefono }}">
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Correo</h4> <input type="text" name="email" class="form-control"
                            value=" {{ $personales->email }}">
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Dirección</h4> <input type="text" name="direccion" class="form-control"
                    ...
                    <div class="col-lg-4">
                        ...
                        <select class="form-control" name="nivel_educativo">
                            <option value="{{ $personales->nivel_educativo }}">{{ $personales->nivel_educativo }}
                            </option>
                    ...
                    <div class="col-lg-4">
                        <h4>Licencia de Conducir</h4>
                        <input type="text" placeholder="0000000000" class="form-control"
                            value="{{ $personales->licencia }}" name="licencia" maxlength="10">
                        <hr>
                    </div>
                    <div class="col-lg-4">
        ...
        <div class="full-height">
            ...
            <div align="left">
                <div class="row">
                    ...
                    <div class="col-lg-6" align="right">
                        <div class="client-avatar" onclick="editar_datos_laborables()" id="boton_datos_laborables"
                            style="cursor: pointer"><img src="{{ asset('/archivos/imagenes/personal/editar.svg') }}">
                        </div>
                    </div>
                </div>
            ...
            @if (isset($persona->id))
                ...
                <div class="row" style="margin-bottom: 50px;" id="vista_datos_laborables">
                    <div class="col-lg-4">
                        <h4>Área </h4>{{ $persona->departamento_area }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Cargo </h4>{{ $persona->cargo }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Tipo Trbajador </h4>{{ $persona->tipo_trabajador }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Sede</h4>{{ $persona->sede }}
                        <hr>
                    </div>

                    <div class="col-lg-4">
                        <h4>Turno</h4>{{ $persona->turno }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Salario</h4>{{ $persona->salario }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Fecha Vinculación</h4>{{ $persona->fecha_vinculacion }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Fecha Retiro</h4>{{ $persona->fecha_retiro }}
                        <hr>
                    </div>

                    <div class="col-lg-4">
                        <h4>Forma Pago</h4>{{ $persona->forma_pago }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Banco Abonado</h4>{{ $persona->banco_renumeracion }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Número Cuenta</h4>{{ $persona->numero_cuenta }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Seguro de Salud</h4>{{ $persona->afiliacion_salud }}
                        <hr>
                    </div>

                    <div class="col-lg-4">
                        <h4>Tipo Contrato</h4>{{ $persona->tipo_contrato }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Régimen Pensionario</h4>{{ $persona->regimen_pensionario }}
                        <hr>
                    </div>
                    <div class="col-lg-4">
                        <h4>Estado Del Trabajador</h4>{{ $persona->estado_trabajador }}
                        <hr>
                    </div>
                </div>
                ...
                <form action="{{ route('personal-datos-laborales.update', $persona->id) }}" enctype="multipart/form-data"
                    method="post">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="row" style="margin-bottom: 50px;" hidden="" id="form_datos_laborables">
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="departamento_area" required="">
                                <option value="{{ $persona->departamento_area }}">{{ $persona->departamento_area }}
                                </option>
                                <option disabled="">------------------------</option>
                        ...
                        <div class="col-lg-4">
                            <h4>Sede</h4> <input type="text" name="sede" class="form-control"
                                value="{{ $persona->sede }}">
                            <hr>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <h4>Salario</h4> <input type="nmber" name="salario" class="form-control"
                                value="{{ $persona->salario }}">
                            <hr>
                        </div>
                        <div class="col-lg-4">
                            <h4>Fecha Vinculación</h4> <input type="date" name="fecha_vinculacion"
                                class="form-control" value="{{ $persona->fecha_vinculacion }}">
                            <hr>
                        </div>
                        <div class="col-lg-4">
                            <h4>Fecha Retiro</h4> <input type="date" name="fecha_retiro" class="form-control"
                                value="{{ $persona->fecha_retiro }}">
                            <hr>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="banco_renumeracion" required="">
                                <option value="{{ $persona->banco_renumeracion }}">{{ $persona->banco_renumeracion }}
                                </option>
                                <option disabled="">------------------------</option>
                        ...
                        <div class="col-lg-4">
                            <h4>Número Cuenta</h4> <input type="text" name="numero_cuenta" class="form-control"
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="afiliacion_salud" required="">
                                <option value=" {{ $persona->afiliacion_salud }}"> {{ $persona->afiliacion_salud }}
                                </option>
                                <option disabled="">------------------------</option>
                        ...
                        <div class="col-lg-4">
                            <h4>Régimen Pensionario</h4>
                            <select class="form-control" name="regimen_pensionario" required="">
                                <option value="{{ $persona->regimen_pensionario }}">{{ $persona->regimen_pensionario }}
                                </option>
                                <option disabled="">------------------------</option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="estado_trabajador" required="">
                                <option value="{{ $persona->estado_trabajador }}">{{ $persona->estado_trabajador }}
                                </option>
                                <option disabled="">------------------------</option>
                        ...
                        <div class="col-lg-4">
                            <h4>Guardar</h4> <input type="submit" name="" class="btn btn-success"
                                value="Guardar">
                            <hr>
                        </div>
                    </div>
