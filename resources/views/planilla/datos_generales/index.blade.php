                                                ...
                                                <td colspan="8">
                                                    <div style="display: flex;">
                                                        ...
                                                        <div style="flex: 2; padding: 10px; text-align: center;">
                                                            <div class="text-center">
                                                                ...
                                                                <button class="btn btn-success"
                                                                    style="margin-right: 10px;">Actualizar Datos</button>
                                                            </div>
                                                        </div>
                                                        <!-- Columna 2: Datos -->
                                                        <div style="flex: 10; padding: 10px;">
                                                            <div>
                                                                <p class=""
                                                                    style="color: white; text-align: center; align-items: center; padding: 7px; font-weight: bold; background-color: #007bff">
                                                                    DATOS GENERALES</p>
                                                            </div>
                                                            <div class="parent"
                                                                style="display: grid; grid-template-columns: repeat(5, 1fr); grid-template-rows: repeat(3, 1fr); gap: 8px;">
                                                                <div class="div1"
                                                                    style="grid-column-start: 1; grid-row-start: 1; background-color: white; font-weight: bold; padding: 5px;">
                                                                    DOCUMENTO
                                                                ...
                                                                <div class="div2"
                                                                    ...
                                                                    <input type="tel"
                                                                        ...
                                                                        style="margin-top: 5px; width: 100%; padding: 5px;">
                                                                </div>
                                                                <div class="div3"
                                                            ...
                                                            <div class="parent"
                                                                ...
                                                                <div class="div11"
                                                                    style="grid-column-start: 1; grid-row-start: 3; background-color: white; font-weight: bold; padding: 5px;">
                                                                    # CUENTA
                                                                    <input type="tel" placeholder="Numero de cuenta"
                                                                        style="margin-top: 5px; width: 100%; padding: 5px;">
                                                                </div>
                                                                <div class="div12"
                                                        ...
                                                        <div style="flex: 2; padding: 10px; text-align: center;">
                                                            <div class="text-center">
                                                                ...
                                                                <div class="form-group row"><label
                                                                        class="col-lg-3 col-form-label">Nombres:</label>
                                                                    <div class="col-lg-9"><input type="nombre"
                                                                            placeholder="Carlos Daniel" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row"><label
                                                                        class="col-lg-3 col-form-label">Apellidos:</label>
                                                                    <div class="col-lg-9"><input type="apellido"
                                                                            placeholder="Roman Berru" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <br>
                                                                <button class="btn btn-success"
