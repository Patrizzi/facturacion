                    ...
                    <div class="row justify-content-md-center" id="superior_form_dg">
                        ...
                        <div class="col-lg-7" style="padding-top:10px">
                            <div class="row justify-content-md-center" align="center">
                                ...
                                <div class="col col-lg-6" style="padding-top:10px"><input required type="text"
                                        list="paises" id="nacionalidad1" class="form-control show" value="Perú"
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="client-avatar"><img
                                        src="{{ asset('/archivos/imagenes/personal/2620463.svg') }}">
                                </div>
                            </div>
                ...
                <div class="full-height">
                    ...
                    <div align="left">
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="client-avatar"><img
                                        src="{{ asset('/archivos/imagenes/personal/laborable.svg') }}">
                                </div>
                            </div>
                            <div class="col-lg-10" style="margin-top: 10px">
                    ...
                    <div class="row" style="margin-bottom: 50px;" id="form_datos_laborables">
                        ...
                        <div class="col-lg-4">
                            <h4>Fecha Viculacion</h4> <input type="date" name="fecha_vinculacion"
                                class="form-control">
                            <hr>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <input type="text" name="estado_trabajador" class="form-control" value="Activo"
                            hidden="">
                        <div class="col-lg-4">
