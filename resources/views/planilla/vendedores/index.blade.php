                ...
                <ul class="list-group elements-list">
                    @foreach ($vendedores as $vendedor)
                        <li class="list-group-item">
                            <a onclick="myFunction{{ $vendedor->id }}()" class="nav-link" data-toggle="tab"
                                href="#tab-{{ $vendedor->id }}" style="padding-top: 5px;padding-bottom: 5px;">
                                ...
                                <div class="small m-t-xs">
                                    ...
                                    <p class="m-b-none">
                                        <i class="fa fa-user"></i> {{ $vendedor->personal->tipo_trabajador }}<span
            ...
            <div class="full-height-scroll white-bg border-left">
                <div>
                    <div class="tab-content">
                                                ...
                                                <div class="ibox-title" style="padding-right: 3.1%;padding-left:  3.1%">
                                                    <div class="row tooltip-demo">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <a class="btn btn-default procesado" style="width: 80px"
                                                        ...
                                                        <div class="col-sm-6" align="right">
                                                            <!-- Vendedor modal -->
                                                            <button aling='lefth' type="button" class="btn btn-info"
                                                                data-toggle="modal"
                                                                data-target="#exampleModal{{ $vendedor->id }}">Editar
                                                                Vendedor</button>

                                                            <!-- Vendedor Modal -->
                                                            <div class="modal fade" id="exampleModal{{ $vendedor->id }}"
                                                                    ...
                                                                    <div class="modal-content" style="width: 550px">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="exampleModalLabel">Edit Vendedor</h5>
                        ...
                        {{-- <div
                            style="background: #fff; border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.03); margin: 40px 0; padding: 32px; font-family: 'Outfit', sans-serif;">
                            <div
                                style="border-bottom: 1px solid #e7eaec; margin-bottom: 18px; display: flex; align-items: center; justify-content: space-between;">
                                <div style="display: flex; align-items: center;">
                                    <a href="#" style="text-decoration: none; margin-right: 20px;">
                                        <i class="fa fa-arrow-left" style="font-size: 24px; color: black;"></i>
                                    </a>
                                    <h2
                                        style="font-family: 'Outfit', sans-serif; font-weight: bold; margin: 0; color: #000;">
                                        Vendedor</h2>
                                </div>
                            ...
                            <div class="row mb-2" style="margin-bottom: 18px;">
                                <div class="col-md-6 d-flex align-items-center mb-2">
                                    ...
                                    <a class="btn btn-default procesado ms-2"
                                        style="width: 80px; margin-left:10px; background:#f3f3f4; color:#000; font-weight:600; border-radius:12px;">S/150.0</a>
                                    <a class="btn btn-default procesado ms-2"
                                        style="width: 80px; margin-left:10px; background:#f3f3f4; color:#000; font-weight:600; border-radius:12px;">US$80.0</a>
                                </div>
                                <div class="col-md-6 d-flex align-items-center justify-content-end mb-2">
                                    <button type="button" class="btn btn-info"
                                        style="border-radius: 8px; font-weight:600; padding: 6px 22px;"
                                        onclick="this.nextElementSibling.style.display='flex'">Editar Vendedor</button>
                                    <!-- MODAL SOLO FRONT-END, SIN FUNCIONES -->
                                    <div id="modalEditarVendedor"
                                        ...
                                        <div style="background:#fff; border-radius:18px; max-width:540px; width:95vw; margin:auto; box-shadow:0 4px 24px rgba(0,0,0,0.10); padding:32px 32px 18px 32px; position:relative;"
                                            onclick="event.stopPropagation()">
                                            <button
                                                onclick="document.getElementById('modalEditarVendedor').style.display='none'"
                                                style="position:absolute; top:18px; right:18px; background:none; border:none; font-size:28px; color:#888; cursor:pointer;">&times;</button>
                                            <h3
                                                style="font-family:'Outfit',sans-serif; font-weight:700; color:#222; margin-bottom:18px;">
                                                Editar Vendedor</h3>
                                                ...
                                                <div class="container" style="padding:0; background:transparent;">
                                                    <div class="row marketing">
                                                        <div class="col-lg-6 mb-3">
                                                            <label style="font-weight:600; color:#222;">Codigo
                                                                Vendedor</label>
                                                            <input type="text" class="form-control" value="VEN001"
                                                                disabled
                                                                style="background:#f3f3f4; border-radius:12px; font-weight:500;">
                                                        </div>
                                                        <div class="col-lg-6 mb-3">
                                                            <label style="font-weight:600; color:#222;">Nombre
                                                                Vendedor:</label>
                                                            <input type="text" class="form-control"
                                                                value="Juan Pérez - Empleado" readonly
                                                                style="background:#f3f3f4; border-radius:12px; font-weight:500;">
                                                        </div>
                                                        <div class="col-lg-6 mb-3">
                                                            <label style="font-weight:600; color:#222;">Tipo de
                                                                Comision</label>
                                                            <select class="form-control" required
                                                                style="border-radius:12px;">
                                                                <option value="Porcentaje de Venta">Porcentaje de Venta
                                                                </option>
                                                        ...
                                                        <div class="col-lg-12 d-flex justify-content-end mt-2">
                                                            <button class="btn btn-primary" type="submit"
                                                                style="border-radius:8px; font-weight:600; padding:8px 32px;">Grabar</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                ...
                                <table class="table" style="width:100%; border-collapse:separate; border-spacing:0 8px;">
                                    <thead style="background: none;">
                                        <tr style="background: none;">
                                            <th style="font-weight:700; color:#222; background: none; border:none;">Item
                                            </th>
                                            <th style="font-weight:700; color:#222; background: none; border:none;">Cod
                                                Cotizador</th>
                                            <th style="font-weight:700; color:#222; background: none; border:none;">Cod
                                                Boleta/Factura</th>
                                            <th style="font-weight:700; color:#222; background: none; border:none;">Estado
                                                de Boleta/factura</th>
                                            <th style="font-weight:700; color:#222; background: none; border:none;">Costo
                                                Total</th>
                                            <th style="font-weight:700; color:#222; background: none; border:none;">
                                                Comision</th>
                                            <th style="font-weight:700; color:#222; background: none; border:none;">
                                                Liquidacion</th>
                                            <th style="font-weight:700; color:#222; background: none; border:none;">
                                    ...
                                    <tbody>
                                        <tr
                                            style="background: #f3f3f4; border-radius: 12px; box-shadow: 0 1px 2px rgba(0,0,0,0.01);">
                                            <td style="border:none; border-radius: 12px 0 0 12px; font-weight:500;">1</td>
                                            <td style="border:none;">
                                                <a href="#" target="_blank"
                                                    style="color:#2563eb; font-weight:600; text-decoration:underline;">COT-001</a>
                                            </td>
                                        ...
                                        <tr
                                            ...
                                            <td style="border:none;">
                                                <a href="#" target="_blank"
                                                    style="color:#2563eb; font-weight:600; text-decoration:underline;">COT-002</a>
                                            </td>
